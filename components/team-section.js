...
const TeamSection = (props) => {
  ...
  return (
    <>
      <section
        className={`team-section-thq-team-section-elm team-section ${props.rootClassName} `}
      >
          ...
          <div className="team-layout">
            <div className="team-info">
              <h2 className="section-title">
                {props.sectionTitle ?? (
                  <Fragment>
                    <span className="team-section-text12">
                      <span
              ...
              <p className="section-content">
                {props.sectionContent ?? (
                  <Fragment>
                    <span className="team-section-text20">
                      <span
                        dangerouslySetInnerHTML={{
              ...
              <div className="stats-chips">
                <span className="chip">
                  {props.chip ?? (
                    <Fragment>
                      <span className="team-section-text14">
                        <span
                          dangerouslySetInnerHTML={{
                ...
                <span className="chip">
                  {props.chip1 ?? (
                    <Fragment>
                      <span className="team-section-text13">
                        <span
                          dangerouslySetInnerHTML={{
                ...
                <span className="chip">
                  {props.chip2 ?? (
                    <Fragment>
                      <span className="team-section-text15">
                        <span
                          dangerouslySetInnerHTML={{
              ...
              <div className="glass-card team-card">
                ...
                <span className="section-subtitle">
                  {props.sectionSubtitle ?? (
                    <Fragment>
                      <span className="team-section-text16">
                        <span
                          dangerouslySetInnerHTML={{
              ...
              <div className="glass-card team-card">
                ...
                <span className="section-subtitle">
                  {props.sectionSubtitle1 ?? (
                    <Fragment>
                      <span className="team-section-text10">
                        <span
                          dangerouslySetInnerHTML={{
              ...
              <div className="glass-card team-card">
                ...
                <span className="section-subtitle">
                  {props.sectionSubtitle2 ?? (
                    <Fragment>
                      <span className="team-section-text17">
                        <span
                          dangerouslySetInnerHTML={{
              ...
              <div className="glass-card team-card">
                ...
                <span className="section-subtitle">
                  {props.sectionSubtitle3 ?? (
                    <Fragment>
                      <span className="team-section-text18">
                        <span
                          dangerouslySetInnerHTML={{
              ...
              <div className="glass-card team-card">
                ...
                <span className="section-subtitle">
                  {props.sectionSubtitle4 ?? (
                    <Fragment>
                      <span className="team-section-text11">
                        <span
                          dangerouslySetInnerHTML={{
              ...
              <div className="glass-card team-card">
                ...
                <span className="section-subtitle">
                  {props.sectionSubtitle5 ?? (
                    <Fragment>
                      <span className="team-section-text19">
                        <span
                          dangerouslySetInnerHTML={{
      ...
      <style jsx>
        {`
          .team-section-thq-team-section-elm {
            position: relative;
          }
          .team-section-text10 {
