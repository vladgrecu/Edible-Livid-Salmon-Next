...
const TeamSection4 = (props) => {
  const translate = useTranslations()
  return (
    <>
      <section
        className={`team-section4-thq-thq-team-section-elm-elm team-section ${props.rootClassName} `}
      >
              ...
              <div className="glass-card team-card">
                ...
                <span className="section-subtitle">
                  {props.sectionSubtitle ?? (
                    <Fragment>
                      <span className="team-section4-text16">
                        <span
                          dangerouslySetInnerHTML={{
              ...
              <div className="glass-card team-card">
                ...
                <span className="section-subtitle">
                  {props.sectionSubtitle2 ?? (
                    <Fragment>
                      <span className="team-section4-text17">
                        <span
                          dangerouslySetInnerHTML={{
      ...
      <style jsx>
        {`
          .team-section4-thq-thq-team-section-elm-elm {
            position: relative;
          }
          .team-section4-text10 {
            display: inline-block;
          }
          .team-section4-text11 {
            display: inline-block;
          }
          .team-section4-text12 {
            display: inline-block;
          }
          .team-section4-text13 {
            display: inline-block;
          }
          .team-section4-text14 {
            display: inline-block;
          }
          .team-section4-text15 {
            display: inline-block;
          }
          .team-section4-text16 {
            display: inline-block;
          }
          .team-section4-text17 {
            display: inline-block;
          }
          .team-section4-text18 {
            display: inline-block;
          }
          .team-section4-text19 {
            display: inline-block;
          }
          .team-section4-text20 {
            display: inline-block;
          }
        `}
      </style>
