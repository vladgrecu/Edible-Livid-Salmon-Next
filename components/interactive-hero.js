...
const InteractiveHero = (props) => {
  ...
  return (
    <>
      <div className="interactive-hero-container1">
        <div className="interactive-hero-container2">
          <div className="interactive-hero-container3">
            <Script
              html={`<style>
...
.interactive-hero-stat-card:hover {
  transform: none;
          ...
          <div className="interactive-hero-container">
            <div className="interactive-hero-content">
                ...
                <span className="section-content">
                  <span
                    dangerouslySetInnerHTML={{
                      __html: translate.raw('SectionContent_p2lBGa'),
                    }}
                  ></span>
                </span>
              </div>
              <h1 className="hero-title">
                <span
                  dangerouslySetInnerHTML={{
                    __html: translate.raw('HeroTitle_thse0m'),
                  }}
                ></span>
              </h1>
              <p className="hero-subtitle">
                <span
                  dangerouslySetInnerHTML={{
                    __html: translate.raw('HeroSubtitle_Bt3dqY'),
                  }}
                ></span>
              </p>
                ...
                <a href="#demo">
                  <div className="btn btn-xl btn-primary interactive-hero-btn-xl">
                    <span>
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('text_XnKqKm'),
                        }}
                      ></span>
                    </span>
                    <svg
                ...
                <a href="#pricing">
                  <div className="btn btn-xl interactive-hero-btn-xl btn-outline">
                    <span>
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('text_i2W59M'),
                        }}
                      ></span>
                    </span>
                  </div>
                ...
                <div id="rotatingCube" className="interactive-hero-cube">
                  <div className="interactive-hero-face interactive-hero-front">
                    ...
                    <span className="section-content">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('SectionContent_Ia2t30'),
                        }}
                      ></span>
                    </span>
                  </div>
                  <div className="interactive-hero-face interactive-hero-back">
                    ...
                    <span className="section-content">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('SectionContent_YQ68lT'),
                        }}
                      ></span>
                    </span>
                  </div>
                  <div className="interactive-hero-right interactive-hero-face">
                    <span className="section-content">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('SectionContent_wgXZrA'),
                        }}
                      ></span>
                    </span>
                  </div>
                  <div className="interactive-hero-face interactive-hero-left">
                    <span className="section-content">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('SectionContent_oSHvJ2'),
                        }}
                      ></span>
                    </span>
                  </div>
                  <div className="interactive-hero-face interactive-hero-top">
                    <span className="section-content">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('SectionContent__o65cm'),
                        }}
                      ></span>
                    </span>
                  </div>
                  <div className="interactive-hero-face interactive-hero-bottom">
                    <span className="section-content">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('SectionContent_7xOx8h'),
                        }}
                      ></span>
                    </span>
                  </div>
              ...
              <div className="interactive-hero-stats">
                <div className="interactive-hero-stat-card">
                    ...
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw(
                          'InteractiveHeroStatValue_ZrG0tl'
                        ),
                      }}
                    ></span>
                  </span>
                  <span className="section-content">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw('SectionContent_OpG_oV'),
                      }}
                    ></span>
                  </span>
                </div>
                <div className="interactive-hero-stat-card">
                  <span className="interactive-hero-stat-value">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw(
                          'InteractiveHeroStatValue_2rCCBo'
                        ),
                      }}
                    ></span>
                  </span>
                  <span className="section-content">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw('SectionContent_CWiS5f'),
                      }}
                    ></span>
                  </span>
                </div>
        ...
        <div className="interactive-hero-container4">
          <div className="interactive-hero-container5">
            <Script
              html={`<style>
...
100% {transform: rotateX(360deg) rotateY(360deg);}}
        ...
        <div className="interactive-hero-container6">
          <div className="interactive-hero-container7">
            <Script
...
(function(){
  ...
  document.addEventListener("touchend", () => {
    ...
    setTimeout(() => {
      ...
      <style jsx>
        {`
          .interactive-hero-container1 {
            display: contents;
          }
          .interactive-hero-container2 {
            display: none;
          }
          .interactive-hero-container3 {
            display: contents;
          }
          .interactive-hero-container4 {
            display: none;
          }
          .interactive-hero-container5 {
            display: contents;
          }
          .interactive-hero-container6 {
            display: none;
          }
          .interactive-hero-container7 {
            display: contents;
          }
        `}
      </style>
