...
const WhyExistSection = (props) => {
  ...
  return (
    <>
            ...
            <div className="narrative-card">
              ...
              <blockquote className="pull-quote">
                ...
                <span className="quote-mark">
                  {props.quoteMark1 ?? (
                    <Fragment>
                      <span className="why-exist-section-text8">
                        <span
                          dangerouslySetInnerHTML={{
      ...
      <style jsx>
        {`
          .why-exist-section-thq-why-exist-section-elm {
            position: relative;
          }
          .why-exist-section-text2 {
            display: inline-block;
          }
          .why-exist-section-text3 {
            display: inline-block;
          }
          .why-exist-section-text4 {
            display: inline-block;
          }
          .why-exist-section-text5 {
            display: inline-block;
          }
          .why-exist-section-text6 {
            display: inline-block;
          }
          .why-exist-section-text7 {
            display: inline-block;
          }
          .why-exist-section-text8 {
            display: inline-block;
          }
        `}
      </style>
