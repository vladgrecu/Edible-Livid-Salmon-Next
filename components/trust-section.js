...
const TrustSection = (props) => {
  ...
  return (
    <>
      ...
      <style jsx>
        {`
          .trust-section-thq-trust-section-elm {
            position: relative;
          }
          .trust-section-text19 {
            display: inline-block;
          }
          .trust-section-text20 {
            display: inline-block;
          }
          .trust-section-text21 {
            display: inline-block;
          }
          .trust-section-text22 {
            display: inline-block;
          }
          .trust-section-text23 {
            display: inline-block;
          }
          .trust-section-text24 {
            display: inline-block;
          }
          .trust-section-text25 {
            display: inline-block;
          }
          .trust-section-text26 {
            display: inline-block;
          }
          .trust-section-text27 {
            display: inline-block;
          }
          .trust-section-text28 {
            display: inline-block;
          }
          .trust-section-text29 {
            display: inline-block;
          }
          .trust-section-text30 {
            display: inline-block;
          }
          .trust-section-text31 {
            display: inline-block;
          }
        `}
      </style>
