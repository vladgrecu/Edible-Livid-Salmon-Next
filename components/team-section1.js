...
const TeamSection1 = (props) => {
  const translate = useTranslations()
  return (
    <>
      <section
        className={`team-section1-thq-thq-team-section-elm-elm team-section ${props.rootClassName} `}
      >
          ...
          <div className="team-layout">
            <div className="team-info">
              <h2 className="section-title">
                {props.sectionTitle ?? (
                  <Fragment>
                    <span className="team-section1-text12">
                      <span
              ...
              <div className="glass-card team-card">
                ...
                <span className="section-subtitle">
                  {props.sectionSubtitle1 ?? (
                    <Fragment>
                      <span className="team-section1-text10">
                        <span
                          dangerouslySetInnerHTML={{
      ...
      <style jsx>
        {`
          .team-section1-thq-thq-team-section-elm-elm {
            position: relative;
          }
          .team-section1-text10 {
            display: inline-block;
          }
          .team-section1-text11 {
            display: inline-block;
          }
          .team-section1-text12 {
            display: inline-block;
          }
          .team-section1-text13 {
            display: inline-block;
          }
          .team-section1-text14 {
            display: inline-block;
          }
          .team-section1-text15 {
            display: inline-block;
          }
          .team-section1-text16 {
            display: inline-block;
          }
          .team-section1-text17 {
            display: inline-block;
          }
          .team-section1-text18 {
            display: inline-block;
          }
          .team-section1-text19 {
            display: inline-block;
          }
          .team-section1-text20 {
            display: inline-block;
          }
        `}
      </style>
