...
const InteractiveHero111121 = (props) => {
  const translate = useTranslations()
  return (
    <>
      <div
        className={`interactive-hero111121-container1 ${props.rootClassName} `}
      >
        <div className="interactive-hero111121-container2">
          <div className="interactive-hero111121-container3">
            <Script
              html={`<style>
...
.interactive-hero-stat-card:hover {
  transform: none;
        ...
        <div className="interactive-hero111121-container4">
          <div className="interactive-hero111121-container5">
            <Script
              html={`<style>
...
100% {transform: rotateX(360deg) rotateY(360deg);}}
        ...
        <div className="interactive-hero111121-container6">
          <div className="interactive-hero111121-container7">
            <Script
...
(function(){
  ...
  document.addEventListener("touchend", () => {
    ...
    setTimeout(() => {
      ...
      <style jsx>
        {`
          .interactive-hero111121-container1 {
            display: contents;
          }
          .interactive-hero111121-container2 {
            display: none;
          }
          .interactive-hero111121-container3 {
            display: contents;
          }
          .interactive-hero111121-container4 {
            display: none;
          }
          .interactive-hero111121-container5 {
            display: contents;
          }
          .interactive-hero111121-container6 {
            display: none;
          }
          .interactive-hero111121-container7 {
            display: contents;
          }
        `}
      </style>
...
InteractiveHero111121.defaultProps = {
  rootClassName: '',
}

InteractiveHero111121.propTypes = {
  rootClassName: PropTypes.string,
}

export default InteractiveHero111121
