            ...
            <div className="footer-grid">
              <div className="footer-brand-column">
                    ...
                    <span className="footer-logo-text">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('FooterLogoText_bKAuNE'),
                        }}
                      ></span>
                    </span>
                  </div>
                ...
                <p className="footer-brand-description section-content">
                  <span
                    dangerouslySetInnerHTML={{
                      __html: translate.raw('SectionContent_3sivPb'),
                    }}
                  ></span>
                </p>
              ...
              >
                ...
                >
                  <span
                    dangerouslySetInnerHTML={{
                      __html: translate.raw('SectionSubtitle_nzTePe'),
                    }}
                  ></span>
                </h2>
                    ...
                    <a href="#">
                      <div className="footer-nav-link">
                        <span>
                          <span
                            dangerouslySetInnerHTML={{
                              __html: translate.raw('text_WCZclh'),
                            }}
                          ></span>
                        </span>
                      </div>
                    ...
                    <a href="#">
                      <div className="footer-nav-link">
                        <span>
                          <span
                            dangerouslySetInnerHTML={{
                              __html: translate.raw('text_I6zHKl'),
                            }}
                          ></span>
                        </span>
                      </div>
                    ...
                    <a href="#">
                      <div className="footer-nav-link">
                        <span>
                          <span
                            dangerouslySetInnerHTML={{
                              __html: translate.raw('text_Z5T0lW'),
                            }}
                          ></span>
                        </span>
                      </div>
                    ...
                    <a href="#">
                      <div className="footer-nav-link">
                        <span>
                          <span
                            dangerouslySetInnerHTML={{
                              __html: translate.raw('text_cVT5FX'),
                            }}
                          ></span>
                        </span>
                      </div>
                    ...
                    <a href="#">
                      <div className="footer-nav-link">
                        <span>
                          <span
                            dangerouslySetInnerHTML={{
                              __html: translate.raw('text_-g_10a'),
                            }}
                          ></span>
                        </span>
                      </div>
              ...
              >
                ...
                >
                  <span
                    dangerouslySetInnerHTML={{
                      __html: translate.raw('SectionSubtitle_t-6K8Q'),
                    }}
                  ></span>
                </h2>
                <ul className="footer-nav-list">
                    ...
                    <a href="#">
                      <div className="footer-nav-link">
                        <span>
                          <span
                            dangerouslySetInnerHTML={{
                              __html: translate.raw('text_GzfzBz'),
                            }}
                          ></span>
                        </span>
                      </div>
                    ...
                    <a href="#">
                      <div className="footer-nav-link">
                        <span>
                          <span
                            dangerouslySetInnerHTML={{
                              __html: translate.raw('text_A2BWWe'),
                            }}
                          ></span>
                        </span>
                      </div>
                    ...
                    <a href="#">
                      <div className="footer-nav-link">
                        <span>
                          <span
                            dangerouslySetInnerHTML={{
                              __html: translate.raw('text_MDJNrJ'),
                            }}
                          ></span>
                        </span>
                      </div>
                    ...
                    <a href="#">
                      <div className="footer-nav-link">
                        <span>
                          <span
                            dangerouslySetInnerHTML={{
                              __html: translate.raw('text_sOM5vp'),
                            }}
                          ></span>
                        </span>
                      </div>
                    ...
                    <a href="#">
                      <div className="footer-nav-link">
                        <span>
                          <span
                            dangerouslySetInnerHTML={{
                              __html: translate.raw('text_JhCYMY'),
                            }}
                          ></span>
                        </span>
                      </div>
              ...
              <div className="footer-newsletter-column">
                <h2 className="footer-nav-title section-subtitle">
                  <span
                    dangerouslySetInnerHTML={{
                      __html: translate.raw('SectionSubtitle_Q_2swO'),
                    }}
                  ></span>
                </h2>
                <p className="footer-newsletter-text section-content">
                  <span
                    dangerouslySetInnerHTML={{
                      __html: translate.raw('SectionContent_v3U3Ty'),
                    }}
                  ></span>
                </p>
                <form
                  action="/subscribe"
                  method="POST"
                  data-form-id="c69ba48a-91a5-4280-bd8d-838364b2ead4"
            ...
            <div className="footer-bottom-bar">
              <div className="footer-legal-links">
                <span className="footer-copyright">
                  <span
                    dangerouslySetInnerHTML={{
                      __html: translate.raw('FooterCopyright_QlPTLW'),
                    }}
                  ></span>
                </span>
                <a href="#">
                  <div className="footer-legal-link">
                    <span>
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('text_ggJpbz'),
                        }}
                      ></span>
                    </span>
                  </div>
                ...
                <a href="#">
                  <div className="footer-legal-link">
                    <span>
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('text_MOwXF3'),
                        }}
                      ></span>
                    </span>
                  </div>
                ...
                <a href="#">
                  <div className="footer-legal-link">
                    <span>
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('text_XGHkPy'),
                        }}
                      ></span>
                    </span>
                  </div>
              ...
              <div className="footer-trust-badges">
                <span className="footer-badge">
                  <span
                    dangerouslySetInnerHTML={{
                      __html: translate.raw('FooterBadge_Qoy5DP'),
                    }}
                  ></span>
                </span>
                <span className="footer-badge">
                  <span
                    dangerouslySetInnerHTML={{
                      __html: translate.raw('FooterBadge_yg9DWe'),
                    }}
                  ></span>
                </span>
              </div>
