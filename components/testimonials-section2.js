...
const TestimonialsSection2 = (props) => {
  const translate = useTranslations()
  return (
    <>
      <section
        className={`testimonials-section2-thq-thq-testimonials-section-elm-elm testimonials-section ${props.rootClassName} `}
      >
        <div className="testimonials-carousel-wrapper">
          <h2 className="section-title">
            {props.sectionTitle ?? (
              <Fragment>
                <span className="testimonials-section2-text16">
                  <span
            ...
            <div className="testimonial-card">
              ...
              <p className="section-content">
                {props.sectionContent ?? (
                  <Fragment>
                    <span className="testimonials-section2-text18">
                      <span
                        dangerouslySetInnerHTML={{
              ...
              <div className="testimonial-author">
                <span className="author-name">
                  {props.authorName ?? (
                    <Fragment>
                      <span className="testimonials-section2-text15">
                        <span
                          dangerouslySetInnerHTML={{
                ...
                <span className="author-role">
                  {props.authorRole ?? (
                    <Fragment>
                      <span className="testimonials-section2-text19">
                        <span
                          dangerouslySetInnerHTML={{
            ...
            <div className="testimonial-card">
              ...
              <p className="section-content">
                {props.sectionContent1 ?? (
                  <Fragment>
                    <span className="testimonials-section2-text11">
                      <span
                        dangerouslySetInnerHTML={{
              ...
              <div className="testimonial-author">
                <span className="author-name">
                  {props.authorName1 ?? (
                    <Fragment>
                      <span className="testimonials-section2-text17">
                        <span
                          dangerouslySetInnerHTML={{
                ...
                <span className="author-role">
                  {props.authorRole1 ?? (
                    <Fragment>
                      <span className="testimonials-section2-text12">
                        <span
                          dangerouslySetInnerHTML={{
            ...
            <div className="testimonial-card">
              ...
              <p className="section-content">
                {props.sectionContent2 ?? (
                  <Fragment>
                    <span className="testimonials-section2-text14">
                      <span
                        dangerouslySetInnerHTML={{
              ...
              <div className="testimonial-author">
                <span className="author-name">
                  {props.authorName2 ?? (
                    <Fragment>
                      <span className="testimonials-section2-text13">
                        <span
                          dangerouslySetInnerHTML={{
                ...
                <span className="author-role">
                  {props.authorRole2 ?? (
                    <Fragment>
                      <span className="testimonials-section2-text10">
                        <span
                          dangerouslySetInnerHTML={{
      ...
      <style jsx>
        {`
          .testimonials-section2-thq-thq-testimonials-section-elm-elm {
            position: relative;
          }
          .testimonials-section2-text10 {
            display: inline-block;
          }
          .testimonials-section2-text11 {
            display: inline-block;
          }
          .testimonials-section2-text12 {
            display: inline-block;
          }
          .testimonials-section2-text13 {
            display: inline-block;
          }
          .testimonials-section2-text14 {
            display: inline-block;
          }
          .testimonials-section2-text15 {
            display: inline-block;
          }
          .testimonials-section2-text16 {
            display: inline-block;
          }
          .testimonials-section2-text17 {
            display: inline-block;
          }
          .testimonials-section2-text18 {
            display: inline-block;
          }
          .testimonials-section2-text19 {
            display: inline-block;
          }
        `}
      </style>
...
TestimonialsSection2.defaultProps = {
...
TestimonialsSection2.propTypes = {
