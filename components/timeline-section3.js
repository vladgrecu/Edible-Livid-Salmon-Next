...
const TimelineSection3 = (props) => {
  const translate = useTranslations()
  return (
    <>
      <section
        className={`timeline-section3-thq-thq-timeline-section-elm-elm timeline-section ${props.rootClassName} `}
      >
        <div className="timeline-container">
          <h2 className="section-title centered">
            {props.sectionTitle ?? (
              <Fragment>
                <span className="timeline-section3-text10">
                  <span
              ...
              <div className="milestone-item">
                ...
                <div className="milestone-content">
                  <span className="date-stamp">
                    {props.dateStamp ?? (
                      <Fragment>
                        <span className="timeline-section3-text11">
                          <span
                            dangerouslySetInnerHTML={{
                  ...
                  <h3 className="section-subtitle">
                    {props.sectionSubtitle ?? (
                      <Fragment>
                        <span className="timeline-section3-text19">
                          <span
                            dangerouslySetInnerHTML={{
                  ...
                  <p className="section-content">
                    {props.sectionContent ?? (
                      <Fragment>
                        <span className="timeline-section3-text15">
                          <span
                            dangerouslySetInnerHTML={{
              ...
              <div className="milestone-item">
                ...
                <div className="milestone-content">
                  <span className="date-stamp">
                    {props.dateStamp1 ?? (
                      <Fragment>
                        <span className="timeline-section3-text20">
                          <span
                            dangerouslySetInnerHTML={{
                  ...
                  <h3 className="section-subtitle">
                    {props.sectionSubtitle1 ?? (
                      <Fragment>
                        <span className="timeline-section3-text13">
                          <span
                            dangerouslySetInnerHTML={{
                  ...
                  <p className="section-content">
                    {props.sectionContent1 ?? (
                      <Fragment>
                        <span className="timeline-section3-text22">
                          <span
                            dangerouslySetInnerHTML={{
              ...
              <div className="milestone-item">
                ...
                <div className="milestone-content">
                  <span className="date-stamp">
                    {props.dateStamp2 ?? (
                      <Fragment>
                        <span className="timeline-section3-text14">
                          <span
                            dangerouslySetInnerHTML={{
                  ...
                  <h3 className="section-subtitle">
                    {props.sectionSubtitle2 ?? (
                      <Fragment>
                        <span className="timeline-section3-text18">
                          <span
                            dangerouslySetInnerHTML={{
                  ...
                  <p className="section-content">
                    {props.sectionContent2 ?? (
                      <Fragment>
                        <span className="timeline-section3-text16">
                          <span
                            dangerouslySetInnerHTML={{
              ...
              <div className="milestone-item">
                ...
                <div className="milestone-content">
                  <span className="date-stamp">
                    {props.dateStamp3 ?? (
                      <Fragment>
                        <span className="timeline-section3-text12">
                          <span
                            dangerouslySetInnerHTML={{
                  ...
                  <h3 className="section-subtitle">
                    {props.sectionSubtitle3 ?? (
                      <Fragment>
                        <span className="timeline-section3-text17">
                          <span
                            dangerouslySetInnerHTML={{
                  ...
                  <p className="section-content">
                    {props.sectionContent3 ?? (
                      <Fragment>
                        <span className="timeline-section3-text21">
                          <span
                            dangerouslySetInnerHTML={{
      ...
      <style jsx>
        {`
          .timeline-section3-thq-thq-timeline-section-elm-elm {
            position: relative;
          }
          .timeline-section3-text10 {
            display: inline-block;
          }
          .timeline-section3-text11 {
            display: inline-block;
          }
          .timeline-section3-text12 {
            display: inline-block;
          }
          .timeline-section3-text13 {
            display: inline-block;
          }
          .timeline-section3-text14 {
            display: inline-block;
          }
          .timeline-section3-text15 {
            display: inline-block;
          }
          .timeline-section3-text16 {
            display: inline-block;
          }
          .timeline-section3-text17 {
            display: inline-block;
          }
          .timeline-section3-text18 {
            display: inline-block;
          }
          .timeline-section3-text19 {
            display: inline-block;
          }
          .timeline-section3-text20 {
            display: inline-block;
          }
          .timeline-section3-text21 {
            display: inline-block;
          }
          .timeline-section3-text22 {
            display: inline-block;
          }
        `}
      </style>
