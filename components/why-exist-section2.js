...
const WhyExistSection2 = (props) => {
  const translate = useTranslations()
  return (
    <>
      <section
        className={`why-exist-section2-thq-thq-why-exist-section-elm-elm why-exist-section ${props.rootClassName} `}
      >
            ...
            <div className="glass-plaque-wrapper">
              <div className="glass-plaque">
                ...
                <h2 className="about-nimbuscloud-hero-title hero-title">
                  {props.heroTitle ?? (
                    <Fragment>
                      <span className="why-exist-section2-text7">
                        <span
                ...
                <p className="plaque-statement">
                  {props.plaqueStatement ?? (
                    <Fragment>
                      <span className="why-exist-section2-text4">
                        <span
                          dangerouslySetInnerHTML={{
            ...
            <div className="narrative-card">
              <p className="typewriter-reveal section-content">
                {props.sectionContent ?? (
                  <Fragment>
                    <span className="why-exist-section2-text6">
                      <span
                        dangerouslySetInnerHTML={{
              ...
              <blockquote className="pull-quote">
                <span className="quote-mark">
                  {props.quoteMark ?? (
                    <Fragment>
                      <span className="why-exist-section2-text2">
                        <span
                          dangerouslySetInnerHTML={{
                ...
                <span>
                  {props.text ?? (
                    <Fragment>
                      <span className="why-exist-section2-text3">
                        <span
                          dangerouslySetInnerHTML={{
                ...
                <span className="quote-mark">
                  {props.quoteMark1 ?? (
                    <Fragment>
                      <span className="why-exist-section2-text5">
                        <span
                          dangerouslySetInnerHTML={{
              ...
              <p className="closing-statement">
                {props.closingStatement ?? (
                  <Fragment>
                    <span className="why-exist-section2-text8">
                      <span
                        dangerouslySetInnerHTML={{
      ...
      <style jsx>
        {`
          .why-exist-section2-thq-thq-why-exist-section-elm-elm {
            position: relative;
          }
          .why-exist-section2-text2 {
            display: inline-block;
          }
          .why-exist-section2-text3 {
            display: inline-block;
          }
          .why-exist-section2-text4 {
            display: inline-block;
          }
          .why-exist-section2-text5 {
            display: inline-block;
          }
          .why-exist-section2-text6 {
            display: inline-block;
          }
          .why-exist-section2-text7 {
            display: inline-block;
          }
          .why-exist-section2-text8 {
            display: inline-block;
          }
        `}
      </style>
...
export default WhyExistSection2
