...
const MissionSection = (props) => {
  ...
  return (
    <>
      <section
        className={`mission-section-thq-mission-section-elm mission-section ${props.rootClassName} `}
      >
          ...
          <div className="mission-grid">
            <div className="mission-copy">
              <h2 className="section-title">
                {props.sectionTitle ?? (
                  <Fragment>
                    <span className="mission-section-text7">
                      <span
              ...
              <p className="section-content">
                {props.sectionContent ?? (
                  <Fragment>
                    <span className="mission-section-text2">
                      <span
                        dangerouslySetInnerHTML={{
              ...
              <div className="magnetic-card pillar-card">
                ...
                <h3 className="section-subtitle">
                  {props.sectionSubtitle ?? (
                    <Fragment>
                      <span className="mission-section-text8">
                        <span
                          dangerouslySetInnerHTML={{
                ...
                <p className="section-content">
                  {props.sectionContent1 ?? (
                    <Fragment>
                      <span className="mission-section-text4">
                        <span
                          dangerouslySetInnerHTML={{
              ...
              <div className="magnetic-card pillar-card">
                ...
                <h3 className="section-subtitle">
                  {props.sectionSubtitle1 ?? (
                    <Fragment>
                      <span className="mission-section-text3">
                        <span
                          dangerouslySetInnerHTML={{
                ...
                <p className="section-content">
                  {props.sectionContent2 ?? (
                    <Fragment>
                      <span className="mission-section-text5">
                        <span
                          dangerouslySetInnerHTML={{
              ...
              <div className="magnetic-card pillar-card">
                ...
                <h3 className="section-subtitle">
                  {props.sectionSubtitle2 ?? (
                    <Fragment>
                      <span className="mission-section-text6">
                        <span
                          dangerouslySetInnerHTML={{
                ...
                <p className="section-content">
                  {props.sectionContent3 ?? (
                    <Fragment>
                      <span className="mission-section-text1">
                        <span
                          dangerouslySetInnerHTML={{
      ...
      <style jsx>
        {`
          .mission-section-thq-mission-section-elm {
            position: relative;
          }
          ...
          .mission-section-text3 {
            display: inline-block;
          }
          .mission-section-text4 {
            display: inline-block;
          }
          .mission-section-text5 {
            display: inline-block;
          }
          .mission-section-text6 {
            display: inline-block;
          }
          .mission-section-text7 {
            display: inline-block;
          }
          .mission-section-text8 {
            display: inline-block;
          }
        `}
      </style>
