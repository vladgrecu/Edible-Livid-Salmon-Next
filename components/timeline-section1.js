...
const TimelineSection1 = (props) => {
  const translate = useTranslations()
  return (
    <>
      <section
        className={`timeline-section1-thq-thq-timeline-section-elm-elm timeline-section ${props.rootClassName} `}
      >
                ...
                <div className="milestone-content">
                  ...
                  <p className="section-content">
                    {props.sectionContent2 ?? (
                      <Fragment>
                        <span className="timeline-section1-text16">
                          <span
                            dangerouslySetInnerHTML={{
      ...
      <style jsx>
        {`
          .timeline-section1-thq-thq-timeline-section-elm-elm {
            position: relative;
          }
          .timeline-section1-text10 {
            display: inline-block;
          }
          .timeline-section1-text11 {
            display: inline-block;
          }
          .timeline-section1-text12 {
            display: inline-block;
          }
          .timeline-section1-text13 {
            display: inline-block;
          }
          .timeline-section1-text14 {
            display: inline-block;
          }
          .timeline-section1-text15 {
            display: inline-block;
          }
          .timeline-section1-text16 {
            display: inline-block;
          }
          .timeline-section1-text17 {
            display: inline-block;
          }
          .timeline-section1-text18 {
            display: inline-block;
          }
          .timeline-section1-text19 {
            display: inline-block;
          }
          .timeline-section1-text20 {
            display: inline-block;
          }
          .timeline-section1-text21 {
            display: inline-block;
          }
          .timeline-section1-text22 {
            display: inline-block;
          }
        `}
      </style>
