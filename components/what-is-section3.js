...
const WhatIsSection3 = (props) => {
  const translate = useTranslations()
  return (
    <>
      <section
        className={`what-is-section3-thq-thq-what-is-section-elm-elm what-is-section ${props.rootClassName} `}
      >
            ...
            <div className="capability-tile glass-chip">
              ...
              <h3 className="section-subtitle">
                {props.sectionSubtitle1 ?? (
                  <Fragment>
                    <span className="what-is-section3-text29">
                      <span
                        dangerouslySetInnerHTML={{
      ...
      <style jsx>
        {`
          .what-is-section3-thq-thq-what-is-section-elm-elm {
            position: relative;
          }
          .what-is-section3-text18 {
            display: inline-block;
          }
          .what-is-section3-text19 {
            display: inline-block;
          }
          .what-is-section3-text20 {
            display: inline-block;
          }
          .what-is-section3-text21 {
            display: inline-block;
          }
          .what-is-section3-text22 {
            display: inline-block;
          }
          .what-is-section3-text23 {
            display: inline-block;
          }
          .what-is-section3-text24 {
            display: inline-block;
          }
          .what-is-section3-text25 {
            display: inline-block;
          }
          .what-is-section3-text26 {
            display: inline-block;
          }
          .what-is-section3-text27 {
            display: inline-block;
          }
          .what-is-section3-text28 {
            display: inline-block;
          }
          .what-is-section3-text29 {
            display: inline-block;
          }
          .what-is-section3-text30 {
            display: inline-block;
          }
          .what-is-section3-text31 {
            display: inline-block;
          }
          .what-is-section3-text32 {
            display: inline-block;
          }
          .what-is-section3-text33 {
            display: inline-block;
          }
          .what-is-section3-text34 {
            display: inline-block;
          }
          .what-is-section3-text35 {
            display: inline-block;
          }
        `}
      </style>
