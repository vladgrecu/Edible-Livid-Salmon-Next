...
const MissionSection1 = (props) => {
  const translate = useTranslations()
  return (
    <>
      <section
        className={`mission-section1-thq-thq-mission-section-elm-elm mission-section ${props.rootClassName} `}
      >
      ...
      <style jsx>
        {`
          .mission-section1-thq-thq-mission-section-elm-elm {
            position: relative;
          }
          .mission-section1-text1 {
            display: inline-block;
          }
          .mission-section1-text2 {
            display: inline-block;
          }
          .mission-section1-text3 {
            display: inline-block;
          }
          .mission-section1-text4 {
            display: inline-block;
          }
          .mission-section1-text5 {
            display: inline-block;
          }
          .mission-section1-text6 {
            display: inline-block;
          }
          .mission-section1-text7 {
            display: inline-block;
          }
          .mission-section1-text8 {
            display: inline-block;
          }
        `}
      </style>
