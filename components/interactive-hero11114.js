...
const InteractiveHero11114 = (props) => {
  const translate = useTranslations()
  return (
    <>
      <div
        className={`interactive-hero11114-container1 ${props.rootClassName} `}
      >
        <div className="interactive-hero11114-container2">
          <div className="interactive-hero11114-container3">
            <Script
              html={`<style>
...
.interactive-hero-stat-card:hover {
  transform: none;
        ...
        <div className="interactive-hero11114-container4">
          <div className="interactive-hero11114-container5">
            <Script
              html={`<style>
...
100% {transform: rotateX(360deg) rotateY(360deg);}}
        ...
        <div className="interactive-hero11114-container6">
          <div className="interactive-hero11114-container7">
            <Script
...
(function(){
  ...
  document.addEventListener("touchend", () => {
    ...
    setTimeout(() => {
      ...
      <style jsx>
        {`
          .interactive-hero11114-container1 {
            display: contents;
          }
          .interactive-hero11114-container2 {
            display: none;
          }
          .interactive-hero11114-container3 {
            display: contents;
          }
          .interactive-hero11114-container4 {
            display: none;
          }
          .interactive-hero11114-container5 {
            display: contents;
          }
          .interactive-hero11114-container6 {
            display: none;
          }
          .interactive-hero11114-container7 {
            display: contents;
          }
        `}
      </style>
...
InteractiveHero11114.defaultProps = {
  rootClassName: '',
}

InteractiveHero11114.propTypes = {
  rootClassName: PropTypes.string,
}

export default InteractiveHero11114
