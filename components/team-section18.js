...
const TeamSection18 = (props) => {
  const translate = useTranslations()
  return (
    <>
      <section
        className={`team-section18-thq-thq-team-section-elm-elm team-section ${props.rootClassName} `}
      >
          ...
          <div className="team-layout">
            <div className="team-info">
              <h2 className="section-title">
                {props.sectionTitle ?? (
                  <Fragment>
                    <span className="team-section18-text19">
                      <span
              ...
              <p className="section-content">
                {props.sectionContent ?? (
                  <Fragment>
                    <span className="team-section18-text16">
                      <span
                        dangerouslySetInnerHTML={{
              ...
              <div className="stats-chips">
                <span className="chip">
                  {props.chip ?? (
                    <Fragment>
                      <span className="team-section18-text11">
                        <span
                          dangerouslySetInnerHTML={{
                ...
                <span className="chip">
                  {props.chip1 ?? (
                    <Fragment>
                      <span className="team-section18-text12">
                        <span
                          dangerouslySetInnerHTML={{
                ...
                <span className="chip">
                  {props.chip2 ?? (
                    <Fragment>
                      <span className="team-section18-text10">
                        <span
                          dangerouslySetInnerHTML={{
              ...
              <div className="glass-card team-card">
                ...
                <span className="section-subtitle">
                  {props.sectionSubtitle ?? (
                    <Fragment>
                      <span className="team-section18-text20">
                        <span
                          dangerouslySetInnerHTML={{
              ...
              <div className="glass-card team-card">
                ...
                <span className="section-subtitle">
                  {props.sectionSubtitle1 ?? (
                    <Fragment>
                      <span className="team-section18-text14">
                        <span
                          dangerouslySetInnerHTML={{
              ...
              <div className="glass-card team-card">
                ...
                <span className="section-subtitle">
                  {props.sectionSubtitle2 ?? (
                    <Fragment>
                      <span className="team-section18-text13">
                        <span
                          dangerouslySetInnerHTML={{
              ...
              <div className="glass-card team-card">
                ...
                <span className="section-subtitle">
                  {props.sectionSubtitle3 ?? (
                    <Fragment>
                      <span className="team-section18-text17">
                        <span
                          dangerouslySetInnerHTML={{
              ...
              <div className="glass-card team-card">
                ...
                <span className="section-subtitle">
                  {props.sectionSubtitle4 ?? (
                    <Fragment>
                      <span className="team-section18-text18">
                        <span
                          dangerouslySetInnerHTML={{
              ...
              <div className="glass-card team-card">
                ...
                <span className="section-subtitle">
                  {props.sectionSubtitle5 ?? (
                    <Fragment>
                      <span className="team-section18-text15">
                        <span
                          dangerouslySetInnerHTML={{
      ...
      <style jsx>
        {`
          .team-section18-thq-thq-team-section-elm-elm {
            position: relative;
          }
          .team-section18-text10 {
            display: inline-block;
          }
          .team-section18-text11 {
            display: inline-block;
          }
          .team-section18-text12 {
            display: inline-block;
          }
          .team-section18-text13 {
            display: inline-block;
          }
          .team-section18-text14 {
            display: inline-block;
          }
          .team-section18-text15 {
            display: inline-block;
          }
          .team-section18-text16 {
            display: inline-block;
          }
          .team-section18-text17 {
            display: inline-block;
          }
          .team-section18-text18 {
            display: inline-block;
          }
          .team-section18-text19 {
            display: inline-block;
          }
          .team-section18-text20 {
            display: inline-block;
          }
        `}
      </style>
