            ...
            <div className="footer-grid">
              <div className="footer-brand-column">
                    ...
                    <span className="footer-logo-text">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('FooterLogoText_SAFwJA'),
                        }}
                      ></span>
                    </span>
                  </div>
                ...
                <p className="footer-brand-description section-content">
                  <span
                    dangerouslySetInnerHTML={{
                      __html: translate.raw('SectionContent_DCrZmg'),
                    }}
                  ></span>
                </p>
              ...
              >
                ...
                >
                  <span
                    dangerouslySetInnerHTML={{
                      __html: translate.raw('SectionSubtitle_B-PRuI'),
                    }}
                  ></span>
                </h2>
                    ...
                    <a href="#">
                      <div className="footer-nav-link">
                        <span>
                          <span
                            dangerouslySetInnerHTML={{
                              __html: translate.raw('text_jI5tc5'),
                            }}
                          ></span>
                        </span>
                      </div>
                    ...
                    <a href="#">
                      <div className="footer-nav-link">
                        <span>
                          <span
                            dangerouslySetInnerHTML={{
                              __html: translate.raw('text_YQyaGO'),
                            }}
                          ></span>
                        </span>
                      </div>
                    ...
                    <a href="#">
                      <div className="footer-nav-link">
                        <span>
                          <span
                            dangerouslySetInnerHTML={{
                              __html: translate.raw('text_H3pQoR'),
                            }}
                          ></span>
                        </span>
                      </div>
                    ...
                    <a href="#">
                      <div className="footer-nav-link">
                        <span>
                          <span
                            dangerouslySetInnerHTML={{
                              __html: translate.raw('text_QIPdEe'),
                            }}
                          ></span>
                        </span>
                      </div>
                    ...
                    <a href="#">
                      <div className="footer-nav-link">
                        <span>
                          <span
                            dangerouslySetInnerHTML={{
                              __html: translate.raw('text_ISToS_'),
                            }}
                          ></span>
                        </span>
                      </div>
              ...
              >
                ...
                >
                  <span
                    dangerouslySetInnerHTML={{
                      __html: translate.raw('SectionSubtitle_gAQ4Ft'),
                    }}
                  ></span>
                </h2>
                <ul className="footer-nav-list">
                    ...
                    <a href="#">
                      <div className="footer-nav-link">
                        <span>
                          <span
                            dangerouslySetInnerHTML={{
                              __html: translate.raw('text_hLDuVp'),
                            }}
                          ></span>
                        </span>
                      </div>
                    ...
                    <a href="#">
                      <div className="footer-nav-link">
                        <span>
                          <span
                            dangerouslySetInnerHTML={{
                              __html: translate.raw('text_1aUeO7'),
                            }}
                          ></span>
                        </span>
                      </div>
                    ...
                    <a href="#">
                      <div className="footer-nav-link">
                        <span>
                          <span
                            dangerouslySetInnerHTML={{
                              __html: translate.raw('text_e4QZ23'),
                            }}
                          ></span>
                        </span>
                      </div>
                    ...
                    <a href="#">
                      <div className="footer-nav-link">
                        <span>
                          <span
                            dangerouslySetInnerHTML={{
                              __html: translate.raw('text_AptsWK'),
                            }}
                          ></span>
                        </span>
                      </div>
                    ...
                    <a href="#">
                      <div className="footer-nav-link">
                        <span>
                          <span
                            dangerouslySetInnerHTML={{
                              __html: translate.raw('text_SmG3YK'),
                            }}
                          ></span>
                        </span>
                      </div>
              ...
              <div className="footer-newsletter-column">
                <h2 className="footer-nav-title section-subtitle">
                  <span
                    dangerouslySetInnerHTML={{
                      __html: translate.raw('SectionSubtitle_jjtfgN'),
                    }}
                  ></span>
                </h2>
                <p className="footer-newsletter-text section-content">
                  <span
                    dangerouslySetInnerHTML={{
                      __html: translate.raw('SectionContent_PEFgbq'),
                    }}
                  ></span>
                </p>
                <form
                  action="/subscribe"
                  method="POST"
                  data-form-id="78fad3af-7507-40a8-9c81-fbeecf7d387b"
            ...
            <div className="footer-bottom-bar">
              <div className="footer-legal-links">
                <span className="footer-copyright">
                  <span
                    dangerouslySetInnerHTML={{
                      __html: translate.raw('FooterCopyright_ySECoW'),
                    }}
                  ></span>
                </span>
                <a href="#">
                  <div className="footer-legal-link">
                    <span>
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('text_HJWhOq'),
                        }}
                      ></span>
                    </span>
                  </div>
                ...
                <a href="#">
                  <div className="footer-legal-link">
                    <span>
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('text_XsLSFO'),
                        }}
                      ></span>
                    </span>
                  </div>
                ...
                <a href="#">
                  <div className="footer-legal-link">
                    <span>
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('text_CJvjf3'),
                        }}
                      ></span>
                    </span>
                  </div>
              ...
              <div className="footer-trust-badges">
                <span className="footer-badge">
                  <span
                    dangerouslySetInnerHTML={{
                      __html: translate.raw('FooterBadge_A4SYO2'),
                    }}
                  ></span>
                </span>
                <span className="footer-badge">
                  <span
                    dangerouslySetInnerHTML={{
                      __html: translate.raw('FooterBadge_p_ik8Y'),
                    }}
                  ></span>
                </span>
              </div>
