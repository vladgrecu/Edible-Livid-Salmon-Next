...
const InteractiveHero1112 = (props) => {
  const translate = useTranslations()
  return (
    <>
      <div className="interactive-hero1112-container1">
        <div className="interactive-hero1112-container2">
          <div className="interactive-hero1112-container3">
            <Script
              html={`<style>
...
.interactive-hero-stat-card:hover {
  transform: none;
          ...
          <div className="interactive-hero-container">
            <div className="interactive-hero-content">
                ...
                <span className="section-content">
                  <span
                    dangerouslySetInnerHTML={{
                      __html: translate.raw('SectionContent_zrHUJp'),
                    }}
                  ></span>
                </span>
              </div>
              <h1 className="hero-title">
                <span
                  dangerouslySetInnerHTML={{
                    __html: translate.raw('HeroTitle_O7M7oS'),
                  }}
                ></span>
              </h1>
              <p className="hero-subtitle">
                <span
                  dangerouslySetInnerHTML={{
                    __html: translate.raw('HeroSubtitle_zjN898'),
                  }}
                ></span>
              </p>
                ...
                <a href="#demo">
                  <div className="btn btn-xl btn-primary interactive-hero-btn-xl">
                    <span>
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('text_pXGl3i'),
                        }}
                      ></span>
                    </span>
                    <svg
                ...
                <a href="#pricing">
                  <div className="btn btn-xl interactive-hero-btn-xl btn-outline">
                    <span>
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('text_pgkCwJ'),
                        }}
                      ></span>
                    </span>
                  </div>
                ...
                <div id="rotatingCube" className="interactive-hero-cube">
                  <div className="interactive-hero-face interactive-hero-front">
                    ...
                    <span className="section-content">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('SectionContent_kH0Lpd'),
                        }}
                      ></span>
                    </span>
                  </div>
                  <div className="interactive-hero-face interactive-hero-back">
                    ...
                    <span className="section-content">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('SectionContent_Nm2YRF'),
                        }}
                      ></span>
                    </span>
                  </div>
                  <div className="interactive-hero-right interactive-hero-face">
                    <span className="section-content">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('SectionContent_M90U-r'),
                        }}
                      ></span>
                    </span>
                  </div>
                  <div className="interactive-hero-face interactive-hero-left">
                    <span className="section-content">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('SectionContent_3aqvPu'),
                        }}
                      ></span>
                    </span>
                  </div>
                  <div className="interactive-hero-face interactive-hero-top">
                    <span className="section-content">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('SectionContent_GAjo86'),
                        }}
                      ></span>
                    </span>
                  </div>
                  <div className="interactive-hero-face interactive-hero-bottom">
                    <span className="section-content">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('SectionContent_kD5e8m'),
                        }}
                      ></span>
                    </span>
                  </div>
              ...
              <div className="interactive-hero-stats">
                <div className="interactive-hero-stat-card">
                    ...
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw(
                          'InteractiveHeroStatValue_rhziyS'
                        ),
                      }}
                    ></span>
                  </span>
                  <span className="section-content">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw('SectionContent_nWlrgr'),
                      }}
                    ></span>
                  </span>
                </div>
                <div className="interactive-hero-stat-card">
                  <span className="interactive-hero-stat-value">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw(
                          'InteractiveHeroStatValue_r8KVee'
                        ),
                      }}
                    ></span>
                  </span>
                  <span className="section-content">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw('SectionContent_Zv4Mw5'),
                      }}
                    ></span>
                  </span>
                </div>
        ...
        <div className="interactive-hero1112-container4">
          <div className="interactive-hero1112-container5">
            <Script
              html={`<style>
...
100% {transform: rotateX(360deg) rotateY(360deg);}}
        ...
        <div className="interactive-hero1112-container6">
          <div className="interactive-hero1112-container7">
            <Script
...
(function(){
  ...
  document.addEventListener("touchend", () => {
    ...
    setTimeout(() => {
      ...
      <style jsx>
        {`
          .interactive-hero1112-container1 {
            display: contents;
          }
          .interactive-hero1112-container2 {
            display: none;
          }
          .interactive-hero1112-container3 {
            display: contents;
          }
          .interactive-hero1112-container4 {
            display: none;
          }
          .interactive-hero1112-container5 {
            display: contents;
          }
          .interactive-hero1112-container6 {
            display: none;
          }
          .interactive-hero1112-container7 {
            display: contents;
          }
        `}
      </style>
...
export default InteractiveHero1112
