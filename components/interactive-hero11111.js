...
.interactive-hero-stat-card:hover {
  transform: none;
        ...
        <div className="interactive-hero11111-container4">
          <div className="interactive-hero11111-container5">
            <Script
              html={`<style>
...
100% {transform: rotateX(360deg) rotateY(360deg);}}
        ...
        <div className="interactive-hero11111-container6">
          <div className="interactive-hero11111-container7">
            <Script
...
(function(){
  ...
  document.addEventListener("touchend", () => {
    ...
    setTimeout(() => {
      ...
      <style jsx>
        {`
          .interactive-hero11111-container1 {
            display: contents;
          }
          .interactive-hero11111-container2 {
            display: none;
          }
          .interactive-hero11111-container3 {
            display: contents;
          }
          .interactive-hero11111-container4 {
            display: none;
          }
          .interactive-hero11111-container5 {
            display: contents;
          }
          .interactive-hero11111-container6 {
            display: none;
          }
          .interactive-hero11111-container7 {
            display: contents;
          }
        `}
      </style>
