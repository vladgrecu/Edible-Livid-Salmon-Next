...
const MissionSection14 = (props) => {
  const translate = useTranslations()
  return (
    <>
      <section
        className={`mission-section14-thq-thq-mission-section-elm-elm mission-section ${props.rootClassName} `}
      >
          ...
          <div className="mission-grid">
            <div className="mission-copy">
              <h2 className="section-title">
                {props.sectionTitle ?? (
                  <Fragment>
                    <span className="mission-section14-text7">
                      <span
              ...
              <p className="section-content">
                {props.sectionContent ?? (
                  <Fragment>
                    <span className="mission-section14-text3">
                      <span
                        dangerouslySetInnerHTML={{
              ...
              <div className="magnetic-card pillar-card">
                ...
                <h3 className="section-subtitle">
                  {props.sectionSubtitle ?? (
                    <Fragment>
                      <span className="mission-section14-text2">
                        <span
                          dangerouslySetInnerHTML={{
                ...
                <p className="section-content">
                  {props.sectionContent1 ?? (
                    <Fragment>
                      <span className="mission-section14-text5">
                        <span
                          dangerouslySetInnerHTML={{
              ...
              <div className="magnetic-card pillar-card">
                ...
                <h3 className="section-subtitle">
                  {props.sectionSubtitle1 ?? (
                    <Fragment>
                      <span className="mission-section14-text1">
                        <span
                          dangerouslySetInnerHTML={{
                ...
                <p className="section-content">
                  {props.sectionContent2 ?? (
                    <Fragment>
                      <span className="mission-section14-text4">
                        <span
                          dangerouslySetInnerHTML={{
              ...
              <div className="magnetic-card pillar-card">
                ...
                <h3 className="section-subtitle">
                  {props.sectionSubtitle2 ?? (
                    <Fragment>
                      <span className="mission-section14-text8">
                        <span
                          dangerouslySetInnerHTML={{
                ...
                <p className="section-content">
                  {props.sectionContent3 ?? (
                    <Fragment>
                      <span className="mission-section14-text6">
                        <span
                          dangerouslySetInnerHTML={{
      ...
      <style jsx>
        {`
          .mission-section14-thq-thq-mission-section-elm-elm {
            position: relative;
          }
          .mission-section14-text1 {
            display: inline-block;
          }
          .mission-section14-text2 {
            display: inline-block;
          }
          .mission-section14-text3 {
            display: inline-block;
          }
          .mission-section14-text4 {
            display: inline-block;
          }
          .mission-section14-text5 {
            display: inline-block;
          }
          .mission-section14-text6 {
            display: inline-block;
          }
          .mission-section14-text7 {
            display: inline-block;
          }
          .mission-section14-text8 {
            display: inline-block;
          }
        `}
      </style>
...
export default MissionSection14
