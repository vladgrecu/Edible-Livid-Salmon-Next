...
.interactive-hero-stat-card:hover {
  transform: none;
        ...
        <div className="interactive-hero1111-container4">
          <div className="interactive-hero1111-container5">
            <Script
              html={`<style>
...
100% {transform: rotateX(360deg) rotateY(360deg);}}
        ...
        <div className="interactive-hero1111-container6">
          <div className="interactive-hero1111-container7">
            <Script
...
(function(){
  ...
  document.addEventListener("touchend", () => {
    ...
    setTimeout(() => {
      ...
      <style jsx>
        {`
          .interactive-hero1111-container1 {
            display: contents;
          }
          .interactive-hero1111-container2 {
            display: none;
          }
          .interactive-hero1111-container3 {
            display: contents;
          }
          .interactive-hero1111-container4 {
            display: none;
          }
          .interactive-hero1111-container5 {
            display: contents;
          }
          .interactive-hero1111-container6 {
            display: none;
          }
          .interactive-hero1111-container7 {
            display: contents;
          }
        `}
      </style>
