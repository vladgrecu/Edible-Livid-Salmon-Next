...
const InteractiveHero111113 = (props) => {
  const translate = useTranslations()
  return (
    <>
      <div className="interactive-hero111113-container1">
        <div className="interactive-hero111113-container2">
          <div className="interactive-hero111113-container3">
            <Script
              html={`<style>
...
.interactive-hero-stat-card:hover {
  transform: none;
        ...
        <div className="interactive-hero111113-container4">
          <div className="interactive-hero111113-container5">
            <Script
              html={`<style>
...
100% {transform: rotateX(360deg) rotateY(360deg);}}
        ...
        <div className="interactive-hero111113-container6">
          <div className="interactive-hero111113-container7">
            <Script
...
(function(){
  ...
  document.addEventListener("touchend", () => {
    ...
    setTimeout(() => {
      ...
      <style jsx>
        {`
          .interactive-hero111113-container1 {
            display: contents;
          }
          .interactive-hero111113-container2 {
            display: none;
          }
          .interactive-hero111113-container3 {
            display: contents;
          }
          .interactive-hero111113-container4 {
            display: none;
          }
          .interactive-hero111113-container5 {
            display: contents;
          }
          .interactive-hero111113-container6 {
            display: none;
          }
          .interactive-hero111113-container7 {
            display: contents;
          }
        `}
      </style>
...
export default InteractiveHero111113
