...
const TestimonialsSection6 = (props) => {
  const translate = useTranslations()
  return (
    <>
      <section
        className={`testimonials-section6-thq-thq-testimonials-section-elm-elm testimonials-section ${props.rootClassName} `}
      >
      ...
      <style jsx>
        {`
          .testimonials-section6-thq-thq-testimonials-section-elm-elm {
            position: relative;
          }
          .testimonials-section6-text10 {
            display: inline-block;
          }
          .testimonials-section6-text11 {
            display: inline-block;
          }
          .testimonials-section6-text12 {
            display: inline-block;
          }
          .testimonials-section6-text13 {
            display: inline-block;
          }
          .testimonials-section6-text14 {
            display: inline-block;
          }
          .testimonials-section6-text15 {
            display: inline-block;
          }
          .testimonials-section6-text16 {
            display: inline-block;
          }
          .testimonials-section6-text17 {
            display: inline-block;
          }
          .testimonials-section6-text18 {
            display: inline-block;
          }
          .testimonials-section6-text19 {
            display: inline-block;
          }
        `}
      </style>
