...
const InteractiveHero11115 = (props) => {
  const translate = useTranslations()
  return (
    <>
      <div
        className={`interactive-hero11115-container1 ${props.rootClassName} `}
      >
        <div className="interactive-hero11115-container2">
          <div className="interactive-hero11115-container3">
            <Script
              html={`<style>
...
.interactive-hero-stat-card:hover {
  transform: none;
        ...
        <div className="interactive-hero11115-container4">
          <div className="interactive-hero11115-container5">
            <Script
              html={`<style>
...
100% {transform: rotateX(360deg) rotateY(360deg);}}
        ...
        <div className="interactive-hero11115-container6">
          <div className="interactive-hero11115-container7">
            <Script
...
(function(){
  ...
  document.addEventListener("touchend", () => {
    ...
    setTimeout(() => {
      ...
      <style jsx>
        {`
          .interactive-hero11115-container1 {
            display: contents;
          }
          .interactive-hero11115-container2 {
            display: none;
          }
          .interactive-hero11115-container3 {
            display: contents;
          }
          .interactive-hero11115-container4 {
            display: none;
          }
          .interactive-hero11115-container5 {
            display: contents;
          }
          .interactive-hero11115-container6 {
            display: none;
          }
          .interactive-hero11115-container7 {
            display: contents;
          }
        `}
      </style>
...
InteractiveHero11115.defaultProps = {
  rootClassName: '',
}

InteractiveHero11115.propTypes = {
  rootClassName: PropTypes.string,
}

export default InteractiveHero11115
