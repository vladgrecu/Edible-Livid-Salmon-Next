...
const CtaSection118 = (props) => {
  const translate = useTranslations()
  return (
    <>
      <section
        className={`cta-section118-thq-thq-cta-section-elm-elm cta-section ${props.rootClassName} `}
      >
        <div className="cta-bento-grid">
          <div className="cta-cell-main">
            <h2 className="section-title">
              {props.sectionTitle ?? (
                <Fragment>
                  <span className="cta-section118-text25">
                    <span
            ...
            <p className="section-subtitle">
              {props.sectionSubtitle ?? (
                <Fragment>
                  <span className="cta-section118-text17">
                    <span
                      dangerouslySetInnerHTML={{
            ...
            <form
              ...
              method="POST"
              data-form-id="692de3a6-44c3-4bc6-a7f4-1094f3250ddb"
              className="cta-form"
            >
              <div className="form-group">
                ...
                >
                  <span>
                    {props.btn ?? (
                      <Fragment>
                        <span className="cta-section118-text16">
                          <span
                            dangerouslySetInnerHTML={{
              ...
              <p className="form-disclaimer">
                {props.formDisclaimer ?? (
                  <Fragment>
                    <span className="cta-section118-text18">
                      <span
                        dangerouslySetInnerHTML={{
          ...
          <div className="cta-cell-links">
            <h3 className="section-title">
              {props.sectionTitle1 ?? (
                <Fragment>
                  <span className="cta-section118-text20">
                    <span
                      dangerouslySetInnerHTML={{
              ...
              <a href="#">
                <div className="btn-link">
                  <span>
                    {props.text1 ?? (
                      <Fragment>
                        <span className="cta-section118-text27">
                          <span
                            dangerouslySetInnerHTML={{
              ...
              <a href="#">
                <div className="btn-link">
                  <span>
                    {props.text2 ?? (
                      <Fragment>
                        <span className="cta-section118-text23">
                          <span
                            dangerouslySetInnerHTML={{
              ...
              <a href="#">
                <div className="btn-link">
                  <span>
                    {props.text3 ?? (
                      <Fragment>
                        <span className="cta-section118-text22">
                          <span
                            dangerouslySetInnerHTML={{
              ...
              <a href="#">
                <div className="btn-link">
                  <span>
                    {props.text4 ?? (
                      <Fragment>
                        <span className="cta-section118-text26">
                          <span
                            dangerouslySetInnerHTML={{
          ...
          <div className="cta-cell-contact">
            <h3 className="section-title">
              {props.sectionTitle2 ?? (
                <Fragment>
                  <span className="cta-section118-text24">
                    <span
                      dangerouslySetInnerHTML={{
            ...
            <p className="section-content">
              {props.sectionContent ?? (
                <Fragment>
                  <span className="cta-section118-text21">
                    <span
                      dangerouslySetInnerHTML={{
            ...
            <a href="mailto:contact@flowvista.com?subject=">
              <div className="btn btn-sm btn-outline">
                <span>
                  {props.text ?? (
                    <Fragment>
                      <span className="cta-section118-text19">
                        <span
                          dangerouslySetInnerHTML={{
      ...
      <style jsx>
        {`
          .cta-section118-thq-thq-cta-section-elm-elm {
            position: relative;
          }
          .cta-section118-text16 {
            display: inline-block;
          }
          .cta-section118-text17 {
            display: inline-block;
          }
          .cta-section118-text18 {
            display: inline-block;
          }
          .cta-section118-text19 {
            display: inline-block;
          }
          .cta-section118-text20 {
            display: inline-block;
          }
          .cta-section118-text21 {
            display: inline-block;
          }
          .cta-section118-text22 {
            display: inline-block;
          }
          .cta-section118-text23 {
            display: inline-block;
          }
          .cta-section118-text24 {
            display: inline-block;
          }
          .cta-section118-text25 {
            display: inline-block;
          }
          .cta-section118-text26 {
            display: inline-block;
          }
          .cta-section118-text27 {
            display: inline-block;
          }
        `}
      </style>
