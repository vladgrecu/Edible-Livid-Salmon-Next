...
const InteractiveHero111112 = (props) => {
  const translate = useTranslations()
  return (
    <>
      <div
        className={`interactive-hero111112-container1 ${props.rootClassName} `}
      >
        <div className="interactive-hero111112-container2">
          <div className="interactive-hero111112-container3">
            <Script
              html={`<style>
...
.interactive-hero-stat-card:hover {
  transform: none;
        ...
        <div className="interactive-hero111112-container4">
          <div className="interactive-hero111112-container5">
            <Script
              html={`<style>
...
100% {transform: rotateX(360deg) rotateY(360deg);}}
        ...
        <div className="interactive-hero111112-container6">
          <div className="interactive-hero111112-container7">
            <Script
...
(function(){
  ...
  document.addEventListener("touchend", () => {
    ...
    setTimeout(() => {
      ...
      <style jsx>
        {`
          .interactive-hero111112-container1 {
            display: contents;
          }
          .interactive-hero111112-container2 {
            display: none;
          }
          .interactive-hero111112-container3 {
            display: contents;
          }
          .interactive-hero111112-container4 {
            display: none;
          }
          .interactive-hero111112-container5 {
            display: contents;
          }
          .interactive-hero111112-container6 {
            display: none;
          }
          .interactive-hero111112-container7 {
            display: contents;
          }
        `}
      </style>
...
InteractiveHero111112.defaultProps = {
  rootClassName: '',
}

InteractiveHero111112.propTypes = {
  rootClassName: PropTypes.string,
}

export default InteractiveHero111112
