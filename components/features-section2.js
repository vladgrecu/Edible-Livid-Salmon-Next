...
const FeaturesSection2 = (props) => {
  ...
  return (
    <>
        ...
        <div className="features-container">
          <div className="features-header">
            <h2 className="section-title">
              {props.sectionTitle ?? (
                <Fragment>
                  <span className="features-section2-text10">
                    <span
      ...
      <style jsx>
        {`
          .features-section2-thq-features-section-elm {
            position: relative;
          }
          .features-section2-text10 {
            display: inline-block;
          }
          .features-section2-text11 {
            display: inline-block;
          }
          .features-section2-text12 {
            display: inline-block;
          }
          .features-section2-text13 {
            display: inline-block;
          }
          .features-section2-text14 {
            display: inline-block;
          }
          .features-section2-text15 {
            display: inline-block;
          }
          .features-section2-text16 {
            display: inline-block;
          }
          .features-section2-text17 {
            display: inline-block;
          }
          .features-section2-text18 {
            display: inline-block;
          }
          .features-section2-text19 {
            display: inline-block;
          }
          .features-section2-text20 {
            display: inline-block;
          }
          .features-section2-text21 {
            display: inline-block;
          }
        `}
      </style>
