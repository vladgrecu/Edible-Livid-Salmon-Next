...
const TimelineSection5 = (props) => {
  const translate = useTranslations()
  return (
    <>
      <section
        className={`timeline-section5-thq-thq-timeline-section-elm-elm timeline-section ${props.rootClassName} `}
      >
        <div className="timeline-container">
          <h2 className="section-title centered">
            {props.sectionTitle ?? (
              <Fragment>
                <span className="timeline-section5-text19">
                  <span
              ...
              <div className="milestone-item">
                ...
                <div className="milestone-content">
                  <span className="date-stamp">
                    {props.dateStamp ?? (
                      <Fragment>
                        <span className="timeline-section5-text18">
                          <span
                            dangerouslySetInnerHTML={{
                  ...
                  <h3 className="section-subtitle">
                    {props.sectionSubtitle ?? (
                      <Fragment>
                        <span className="timeline-section5-text17">
                          <span
                            dangerouslySetInnerHTML={{
                  ...
                  <p className="section-content">
                    {props.sectionContent ?? (
                      <Fragment>
                        <span className="timeline-section5-text10">
                          <span
                            dangerouslySetInnerHTML={{
              ...
              <div className="milestone-item">
                ...
                <div className="milestone-content">
                  <span className="date-stamp">
                    {props.dateStamp1 ?? (
                      <Fragment>
                        <span className="timeline-section5-text13">
                          <span
                            dangerouslySetInnerHTML={{
                  ...
                  <h3 className="section-subtitle">
                    {props.sectionSubtitle1 ?? (
                      <Fragment>
                        <span className="timeline-section5-text20">
                          <span
                            dangerouslySetInnerHTML={{
                  ...
                  <p className="section-content">
                    {props.sectionContent1 ?? (
                      <Fragment>
                        <span className="timeline-section5-text14">
                          <span
                            dangerouslySetInnerHTML={{
              ...
              <div className="milestone-item">
                ...
                <div className="milestone-content">
                  <span className="date-stamp">
                    {props.dateStamp2 ?? (
                      <Fragment>
                        <span className="timeline-section5-text15">
                          <span
                            dangerouslySetInnerHTML={{
                  ...
                  <h3 className="section-subtitle">
                    {props.sectionSubtitle2 ?? (
                      <Fragment>
                        <span className="timeline-section5-text21">
                          <span
                            dangerouslySetInnerHTML={{
                  ...
                  <p className="section-content">
                    {props.sectionContent2 ?? (
                      <Fragment>
                        <span className="timeline-section5-text12">
                          <span
                            dangerouslySetInnerHTML={{
              ...
              <div className="milestone-item">
                ...
                <div className="milestone-content">
                  <span className="date-stamp">
                    {props.dateStamp3 ?? (
                      <Fragment>
                        <span className="timeline-section5-text11">
                          <span
                            dangerouslySetInnerHTML={{
                  ...
                  <h3 className="section-subtitle">
                    {props.sectionSubtitle3 ?? (
                      <Fragment>
                        <span className="timeline-section5-text22">
                          <span
                            dangerouslySetInnerHTML={{
                  ...
                  <p className="section-content">
                    {props.sectionContent3 ?? (
                      <Fragment>
                        <span className="timeline-section5-text16">
                          <span
                            dangerouslySetInnerHTML={{
      ...
      <style jsx>
        {`
          .timeline-section5-thq-thq-timeline-section-elm-elm {
            position: relative;
          }
          .timeline-section5-text10 {
            display: inline-block;
          }
          .timeline-section5-text11 {
            display: inline-block;
          }
          .timeline-section5-text12 {
            display: inline-block;
          }
          .timeline-section5-text13 {
            display: inline-block;
          }
          .timeline-section5-text14 {
            display: inline-block;
          }
          .timeline-section5-text15 {
            display: inline-block;
          }
          .timeline-section5-text16 {
            display: inline-block;
          }
          .timeline-section5-text17 {
            display: inline-block;
          }
          .timeline-section5-text18 {
            display: inline-block;
          }
          .timeline-section5-text19 {
            display: inline-block;
          }
          .timeline-section5-text20 {
            display: inline-block;
          }
          .timeline-section5-text21 {
            display: inline-block;
          }
          .timeline-section5-text22 {
            display: inline-block;
          }
        `}
      </style>
...
export default TimelineSection5
