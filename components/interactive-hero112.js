...
const InteractiveHero112 = (props) => {
  const translate = useTranslations()
  return (
    <>
      <div className="interactive-hero112-container1">
        <div className="interactive-hero112-container2">
          <div className="interactive-hero112-container3">
            <Script
              html={`<style>
...
.interactive-hero-stat-card:hover {
  transform: none;
          ...
          <div className="interactive-hero-container">
            <div className="interactive-hero-content">
                ...
                <span className="section-content">
                  <span
                    dangerouslySetInnerHTML={{
                      __html: translate.raw('SectionContent_8lS98N'),
                    }}
                  ></span>
                </span>
              </div>
              <h1 className="hero-title">
                <span
                  dangerouslySetInnerHTML={{
                    __html: translate.raw('HeroTitle_GeCRFr'),
                  }}
                ></span>
              </h1>
              <p className="hero-subtitle">
                <span
                  dangerouslySetInnerHTML={{
                    __html: translate.raw('HeroSubtitle_Rq4wCY'),
                  }}
                ></span>
              </p>
                ...
                <a href="#demo">
                  <div className="btn btn-xl btn-primary interactive-hero-btn-xl">
                    <span>
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('text_y9Tbs1'),
                        }}
                      ></span>
                    </span>
                    <svg
                ...
                <a href="#pricing">
                  <div className="btn btn-xl interactive-hero-btn-xl btn-outline">
                    <span>
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('text_y1MyFz'),
                        }}
                      ></span>
                    </span>
                  </div>
                ...
                <div id="rotatingCube" className="interactive-hero-cube">
                  <div className="interactive-hero-face interactive-hero-front">
                    ...
                    <span className="section-content">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('SectionContent__8KoyG'),
                        }}
                      ></span>
                    </span>
                  </div>
                  <div className="interactive-hero-face interactive-hero-back">
                    ...
                    <span className="section-content">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('SectionContent_jJq_oj'),
                        }}
                      ></span>
                    </span>
                  </div>
                  <div className="interactive-hero-right interactive-hero-face">
                    <span className="section-content">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('SectionContent_lOL8sk'),
                        }}
                      ></span>
                    </span>
                  </div>
                  <div className="interactive-hero-face interactive-hero-left">
                    <span className="section-content">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('SectionContent_nXNt-y'),
                        }}
                      ></span>
                    </span>
                  </div>
                  <div className="interactive-hero-face interactive-hero-top">
                    <span className="section-content">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('SectionContent_UuxXGP'),
                        }}
                      ></span>
                    </span>
                  </div>
                  <div className="interactive-hero-face interactive-hero-bottom">
                    <span className="section-content">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('SectionContent_McI6mz'),
                        }}
                      ></span>
                    </span>
                  </div>
              ...
              <div className="interactive-hero-stats">
                <div className="interactive-hero-stat-card">
                    ...
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw(
                          'InteractiveHeroStatValue_TZh39i'
                        ),
                      }}
                    ></span>
                  </span>
                  <span className="section-content">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw('SectionContent_5HpHNj'),
                      }}
                    ></span>
                  </span>
                </div>
                <div className="interactive-hero-stat-card">
                  <span className="interactive-hero-stat-value">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw(
                          'InteractiveHeroStatValue_XfLymE'
                        ),
                      }}
                    ></span>
                  </span>
                  <span className="section-content">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw('SectionContent_xjzYnQ'),
                      }}
                    ></span>
                  </span>
                </div>
        ...
        <div className="interactive-hero112-container4">
          <div className="interactive-hero112-container5">
            <Script
              html={`<style>
...
100% {transform: rotateX(360deg) rotateY(360deg);}}
        ...
        <div className="interactive-hero112-container6">
          <div className="interactive-hero112-container7">
            <Script
...
(function(){
  ...
  document.addEventListener("touchend", () => {
    ...
    setTimeout(() => {
      ...
      <style jsx>
        {`
          .interactive-hero112-container1 {
            display: contents;
          }
          .interactive-hero112-container2 {
            display: none;
          }
          .interactive-hero112-container3 {
            display: contents;
          }
          .interactive-hero112-container4 {
            display: none;
          }
          .interactive-hero112-container5 {
            display: contents;
          }
          .interactive-hero112-container6 {
            display: none;
          }
          .interactive-hero112-container7 {
            display: contents;
          }
        `}
      </style>
...
export default InteractiveHero112
