...
const InteractiveHero111 = (props) => {
  const translate = useTranslations()
  return (
    <>
      <div className="interactive-hero111-container1">
        <div className="interactive-hero111-container2">
          <div className="interactive-hero111-container3">
            <Script
              html={`<style>
...
.interactive-hero-stat-card:hover {
  transform: none;
          ...
          <div className="interactive-hero-container">
            <div className="interactive-hero-content">
                ...
                <span className="section-content">
                  <span
                    dangerouslySetInnerHTML={{
                      __html: translate.raw('SectionContent_8Ea4-7'),
                    }}
                  ></span>
                </span>
              </div>
              <h1 className="hero-title">
                <span
                  dangerouslySetInnerHTML={{
                    __html: translate.raw('HeroTitle_D0u35S'),
                  }}
                ></span>
              </h1>
              <p className="hero-subtitle">
                <span
                  dangerouslySetInnerHTML={{
                    __html: translate.raw('HeroSubtitle_HK5NZ6'),
                  }}
                ></span>
              </p>
                ...
                <a href="#demo">
                  <div className="btn btn-xl btn-primary interactive-hero-btn-xl">
                    <span>
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('text_oND2-H'),
                        }}
                      ></span>
                    </span>
                    <svg
                ...
                <a href="#pricing">
                  <div className="btn btn-xl interactive-hero-btn-xl btn-outline">
                    <span>
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('text_KOCUEA'),
                        }}
                      ></span>
                    </span>
                  </div>
                ...
                <div id="rotatingCube" className="interactive-hero-cube">
                  <div className="interactive-hero-face interactive-hero-front">
                    ...
                    <span className="section-content">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('SectionContent_-fkxLL'),
                        }}
                      ></span>
                    </span>
                  </div>
                  <div className="interactive-hero-face interactive-hero-back">
                    ...
                    <span className="section-content">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('SectionContent_lzHwC7'),
                        }}
                      ></span>
                    </span>
                  </div>
                  <div className="interactive-hero-right interactive-hero-face">
                    <span className="section-content">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('SectionContent_IWGgDm'),
                        }}
                      ></span>
                    </span>
                  </div>
                  <div className="interactive-hero-face interactive-hero-left">
                    <span className="section-content">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('SectionContent_USaneN'),
                        }}
                      ></span>
                    </span>
                  </div>
                  <div className="interactive-hero-face interactive-hero-top">
                    <span className="section-content">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('SectionContent_Yi11zb'),
                        }}
                      ></span>
                    </span>
                  </div>
                  <div className="interactive-hero-face interactive-hero-bottom">
                    <span className="section-content">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('SectionContent_xU9wJ0'),
                        }}
                      ></span>
                    </span>
                  </div>
              ...
              <div className="interactive-hero-stats">
                <div className="interactive-hero-stat-card">
                    ...
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw(
                          'InteractiveHeroStatValue_YPopP_'
                        ),
                      }}
                    ></span>
                  </span>
                  <span className="section-content">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw('SectionContent_DBApif'),
                      }}
                    ></span>
                  </span>
                </div>
                <div className="interactive-hero-stat-card">
                  <span className="interactive-hero-stat-value">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw(
                          'InteractiveHeroStatValue_mk48A5'
                        ),
                      }}
                    ></span>
                  </span>
                  <span className="section-content">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw('SectionContent_ni91sZ'),
                      }}
                    ></span>
                  </span>
                </div>
        ...
        <div className="interactive-hero111-container4">
          <div className="interactive-hero111-container5">
            <Script
              html={`<style>
...
100% {transform: rotateX(360deg) rotateY(360deg);}}
        ...
        <div className="interactive-hero111-container6">
          <div className="interactive-hero111-container7">
            <Script
...
(function(){
  ...
  document.addEventListener("touchend", () => {
    ...
    setTimeout(() => {
      ...
      <style jsx>
        {`
          .interactive-hero111-container1 {
            display: contents;
          }
          .interactive-hero111-container2 {
            display: none;
          }
          .interactive-hero111-container3 {
            display: contents;
          }
          .interactive-hero111-container4 {
            display: none;
          }
          .interactive-hero111-container5 {
            display: contents;
          }
          .interactive-hero111-container6 {
            display: none;
          }
          .interactive-hero111-container7 {
            display: contents;
          }
        `}
      </style>
...
export default InteractiveHero111
