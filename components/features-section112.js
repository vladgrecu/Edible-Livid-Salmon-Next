...
const FeaturesSection112 = (props) => {
  const translate = useTranslations()
  return (
    <>
      <section
        className={`features-section112-thq-thq-features-section-elm-elm features-section ${props.rootClassName} `}
      >
        <div className="features-container">
          <div className="features-header">
            <h2 className="section-title">
              {props.sectionTitle ?? (
                <Fragment>
                  <span className="features-section112-text15">
                    <span
            ...
            <p className="section-subtitle">
              {props.sectionSubtitle ?? (
                <Fragment>
                  <span className="features-section112-text12">
                    <span
                      dangerouslySetInnerHTML={{
          ...
          <div className="features-bento-grid">
            <div className="cell-large bento-cell">
              ...
              <h3 className="section-title">
                {props.sectionTitle1 ?? (
                  <Fragment>
                    <span className="features-section112-text19">
                      <span
                        dangerouslySetInnerHTML={{
              ...
              <p className="section-content">
                {props.sectionContent ?? (
                  <Fragment>
                    <span className="features-section112-text20">
                      <span
                        dangerouslySetInnerHTML={{
            ...
            <div className="cell-medium bento-cell">
              ...
              <h3 className="section-title">
                {props.sectionTitle2 ?? (
                  <Fragment>
                    <span className="features-section112-text10">
                      <span
                        dangerouslySetInnerHTML={{
              ...
              <p className="section-content">
                {props.sectionContent1 ?? (
                  <Fragment>
                    <span className="features-section112-text17">
                      <span
                        dangerouslySetInnerHTML={{
            ...
            <div className="cell-small bento-cell">
              ...
              <h4 className="section-title">
                {props.sectionTitle3 ?? (
                  <Fragment>
                    <span className="features-section112-text11">
                      <span
                        dangerouslySetInnerHTML={{
              ...
              <p className="section-content">
                {props.sectionContent2 ?? (
                  <Fragment>
                    <span className="features-section112-text13">
                      <span
                        dangerouslySetInnerHTML={{
            ...
            <div className="cell-small bento-cell">
              ...
              <h4 className="section-title">
                {props.sectionTitle4 ?? (
                  <Fragment>
                    <span className="features-section112-text14">
                      <span
                        dangerouslySetInnerHTML={{
              ...
              <p className="section-content">
                {props.sectionContent3 ?? (
                  <Fragment>
                    <span className="features-section112-text16">
                      <span
                        dangerouslySetInnerHTML={{
            ...
            <div className="cell-medium bento-cell">
              ...
              <h3 className="section-title">
                {props.sectionTitle5 ?? (
                  <Fragment>
                    <span className="features-section112-text21">
                      <span
                        dangerouslySetInnerHTML={{
              ...
              <p className="section-content">
                {props.sectionContent4 ?? (
                  <Fragment>
                    <span className="features-section112-text18">
                      <span
                        dangerouslySetInnerHTML={{
      ...
      <style jsx>
        {`
          .features-section112-thq-thq-features-section-elm-elm {
            position: relative;
          }
          .features-section112-text10 {
            display: inline-block;
          }
          .features-section112-text11 {
            display: inline-block;
          }
          .features-section112-text12 {
            display: inline-block;
          }
          .features-section112-text13 {
            display: inline-block;
          }
          .features-section112-text14 {
            display: inline-block;
          }
          .features-section112-text15 {
            display: inline-block;
          }
          .features-section112-text16 {
            display: inline-block;
          }
          .features-section112-text17 {
            display: inline-block;
          }
          .features-section112-text18 {
            display: inline-block;
          }
          .features-section112-text19 {
            display: inline-block;
          }
          .features-section112-text20 {
            display: inline-block;
          }
          .features-section112-text21 {
            display: inline-block;
          }
        `}
      </style>
...
FeaturesSection112.defaultProps = {
  rootClassName: '',
...
export default FeaturesSection112
