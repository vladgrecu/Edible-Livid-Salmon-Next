...
const FeaturesSection27 = (props) => {
  const translate = useTranslations()
  return (
    <>
      <section
        className={`features-section27-thq-thq-features-section-elm-elm features-section ${props.rootClassName} `}
      >
          ...
          <div className="features-header">
            ...
            <p className="section-subtitle">
              {props.sectionSubtitle ?? (
                <Fragment>
                  <span className="features-section27-text16">
                    <span
                      dangerouslySetInnerHTML={{
      ...
      <style jsx>
        {`
          .features-section27-thq-thq-features-section-elm-elm {
            position: relative;
          }
          .features-section27-text10 {
            display: inline-block;
          }
          .features-section27-text11 {
            display: inline-block;
          }
          .features-section27-text12 {
            display: inline-block;
          }
          .features-section27-text13 {
            display: inline-block;
          }
          .features-section27-text14 {
            display: inline-block;
          }
          .features-section27-text15 {
            display: inline-block;
          }
          .features-section27-text16 {
            display: inline-block;
          }
          .features-section27-text17 {
            display: inline-block;
          }
          .features-section27-text18 {
            display: inline-block;
          }
          .features-section27-text19 {
            display: inline-block;
          }
          .features-section27-text20 {
            display: inline-block;
          }
          .features-section27-text21 {
            display: inline-block;
          }
        `}
      </style>
