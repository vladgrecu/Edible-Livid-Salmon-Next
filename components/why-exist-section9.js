...
const WhyExistSection9 = (props) => {
  const translate = useTranslations()
  return (
    <>
      <section
        className={`why-exist-section9-thq-thq-why-exist-section-elm-elm why-exist-section ${props.rootClassName} `}
      >
      ...
      <style jsx>
        {`
          .why-exist-section9-thq-thq-why-exist-section-elm-elm {
            position: relative;
          }
          .why-exist-section9-text2 {
            display: inline-block;
          }
          .why-exist-section9-text3 {
            display: inline-block;
          }
          .why-exist-section9-text4 {
            display: inline-block;
          }
          .why-exist-section9-text5 {
            display: inline-block;
          }
          .why-exist-section9-text6 {
            display: inline-block;
          }
          .why-exist-section9-text7 {
            display: inline-block;
          }
          .why-exist-section9-text8 {
            display: inline-block;
          }
        `}
      </style>
