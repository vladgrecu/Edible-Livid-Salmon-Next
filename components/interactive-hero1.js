...
const InteractiveHero1 = (props) => {
  const translate = useTranslations()
  return (
    <>
      <div className="interactive-hero1-container1">
        <div className="interactive-hero1-container2">
          <div className="interactive-hero1-container3">
            <Script
              html={`<style>
...
.interactive-hero-stat-card:hover {
  transform: none;
          ...
          <div className="interactive-hero-container">
            <div className="interactive-hero-content">
                ...
                <span className="section-content">
                  <span
                    dangerouslySetInnerHTML={{
                      __html: translate.raw('SectionContent_gsnbIp'),
                    }}
                  ></span>
                </span>
              </div>
              <h1 className="hero-title">
                <span
                  dangerouslySetInnerHTML={{
                    __html: translate.raw('HeroTitle_358rnO'),
                  }}
                ></span>
              </h1>
              <p className="hero-subtitle">
                <span
                  dangerouslySetInnerHTML={{
                    __html: translate.raw('HeroSubtitle_NHWV0P'),
                  }}
                ></span>
              </p>
                ...
                <a href="#demo">
                  <div className="btn btn-xl btn-primary interactive-hero-btn-xl">
                    <span>
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('text_B0pQSg'),
                        }}
                      ></span>
                    </span>
                    <svg
                ...
                <a href="#pricing">
                  <div className="btn btn-xl interactive-hero-btn-xl btn-outline">
                    <span>
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('text_qMpcow'),
                        }}
                      ></span>
                    </span>
                  </div>
                ...
                <div id="rotatingCube" className="interactive-hero-cube">
                  <div className="interactive-hero-face interactive-hero-front">
                    ...
                    <span className="section-content">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('SectionContent_5eJm_Y'),
                        }}
                      ></span>
                    </span>
                  </div>
                  <div className="interactive-hero-face interactive-hero-back">
                    ...
                    <span className="section-content">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('SectionContent_n7W3F3'),
                        }}
                      ></span>
                    </span>
                  </div>
                  <div className="interactive-hero-right interactive-hero-face">
                    <span className="section-content">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('SectionContent_ZW454D'),
                        }}
                      ></span>
                    </span>
                  </div>
                  <div className="interactive-hero-face interactive-hero-left">
                    <span className="section-content">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('SectionContent_PgA9_3'),
                        }}
                      ></span>
                    </span>
                  </div>
                  <div className="interactive-hero-face interactive-hero-top">
                    <span className="section-content">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('SectionContent_WdDerB'),
                        }}
                      ></span>
                    </span>
                  </div>
                  <div className="interactive-hero-face interactive-hero-bottom">
                    <span className="section-content">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('SectionContent_qrEaz4'),
                        }}
                      ></span>
                    </span>
                  </div>
              ...
              <div className="interactive-hero-stats">
                <div className="interactive-hero-stat-card">
                    ...
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw(
                          'InteractiveHeroStatValue_aIR0e3'
                        ),
                      }}
                    ></span>
                  </span>
                  <span className="section-content">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw('SectionContent_7h61vP'),
                      }}
                    ></span>
                  </span>
                </div>
                <div className="interactive-hero-stat-card">
                  <span className="interactive-hero-stat-value">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw(
                          'InteractiveHeroStatValue_EWtitN'
                        ),
                      }}
                    ></span>
                  </span>
                  <span className="section-content">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw('SectionContent_H8krK0'),
                      }}
                    ></span>
                  </span>
                </div>
        ...
        <div className="interactive-hero1-container4">
          <div className="interactive-hero1-container5">
            <Script
              html={`<style>
...
100% {transform: rotateX(360deg) rotateY(360deg);}}
        ...
        <div className="interactive-hero1-container6">
          <div className="interactive-hero1-container7">
            <Script
...
(function(){
  ...
  document.addEventListener("touchend", () => {
    ...
    setTimeout(() => {
      ...
      <style jsx>
        {`
          .interactive-hero1-container1 {
            display: contents;
          }
          .interactive-hero1-container2 {
            display: none;
          }
          .interactive-hero1-container3 {
            display: contents;
          }
          .interactive-hero1-container4 {
            display: none;
          }
          .interactive-hero1-container5 {
            display: contents;
          }
          .interactive-hero1-container6 {
            display: none;
          }
          .interactive-hero1-container7 {
            display: contents;
          }
        `}
      </style>
...
export default InteractiveHero1
