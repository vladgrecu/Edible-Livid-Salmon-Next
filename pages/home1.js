  ...
  return (
    <>
      <div className="home1-container1">
        <Head>
          <title>{translate.raw('text_WKO0Pb')}</title>
          <meta name="description" content={translate.raw('text_hYrlDX')} />
          <meta property="og:title" content={translate.raw('text_WKO0Pb')} />
          <meta
            property="og:description"
            content={translate.raw('text_hYrlDX')}
          />
          <link
            rel="canonical"
          ...
          <link
            rel="alternate"
            hreflang="en"
            href="https://admin.teleporthq.ai/home1"
          />
          <link
            rel="alternate"
            hreflang="es"
            href="https://admin.teleporthq.ai/es/home1"
          />
          <link
            rel="alternate"
            hreflang="x-default"
              ...
              <div className="hero-content-area">
                <div className="hero-text-block">
                  <h1 className="home-hero-title hero-title">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw('HeroTitle_oW7S5v'),
                      }}
                    ></span>
                  </h1>
                  <p className="hero-subtitle home-hero-subtitle">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw('HeroSubtitle_8sTP-z'),
                      }}
                    ></span>
                  </p>
                    ...
                    <a href="#demo">
                      <div className="btn btn-lg btn-primary">
                        <span>
                          <span
                            dangerouslySetInnerHTML={{
                              __html: translate.raw('text_-1VhO1'),
                            }}
                          ></span>
                        </span>
                      </div>
                    ...
                    <a href="#workflow">
                      <div className="btn btn-lg btn-outline">
                        <span>
                          <span
                            dangerouslySetInnerHTML={{
                              __html: translate.raw('text_pnXQdK'),
                            }}
                          ></span>
                        </span>
                      </div>
                  ...
                  <DataProvider
                    ...
                    initialData={props.javascript_PEC_data_data_Cuxc9aVo7I}
            ...
            <div className="features-container">
              <div className="features-header">
                <h2 className="section-title">
                  <span
                    dangerouslySetInnerHTML={{
                      __html: translate.raw('SectionTitle__HxE9G'),
                    }}
                  ></span>
                </h2>
                <p className="section-subtitle">
                  <span
                    dangerouslySetInnerHTML={{
                      __html: translate.raw('SectionSubtitle_IhxrOt'),
                    }}
                  ></span>
                </p>
              </div>
              <div className="features-bento-grid">
                <div className="cell-large bento-cell">
                  ...
                  <h3 className="section-title">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw('SectionTitle_d87rSN'),
                      }}
                    ></span>
                  </h3>
                  <p className="section-content">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw('SectionContent_-ETp3Y'),
                      }}
                    ></span>
                  </p>
                </div>
                <div className="cell-medium bento-cell">
                  ...
                  <h3 className="section-title">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw('SectionTitle_BpdI_6'),
                      }}
                    ></span>
                  </h3>
                  <p className="section-content">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw('SectionContent_qb9Xdl'),
                      }}
                    ></span>
                  </p>
                </div>
                <div className="cell-small bento-cell">
                  ...
                  <h4 className="section-title">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw('SectionTitle_4BeMmq'),
                      }}
                    ></span>
                  </h4>
                  <p className="section-content">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw('SectionContent_2Xqqyb'),
                      }}
                    ></span>
                  </p>
                </div>
                <div className="cell-small bento-cell">
                  ...
                  <h4 className="section-title">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw('SectionTitle_F2UXbZ'),
                      }}
                    ></span>
                  </h4>
                  <p className="section-content">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw('SectionContent_8qz2ym'),
                      }}
                    ></span>
                  </p>
                </div>
                <div className="cell-medium bento-cell">
                  ...
                  <h3 className="section-title">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw('SectionTitle_RS0x-6'),
                      }}
                    ></span>
                  </h3>
                  <p className="section-content">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw('SectionContent_8QFqpu'),
                      }}
                    ></span>
                  </p>
                </div>
            ...
            <div className="dashboard-tabs-layout">
              <div className="dashboard-tabs-nav">
                <button data-target="dash-1" className="tab-trigger active">
                  <span className="home1-thq-tab-label-elm1">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw('TabLabel_UehJmq'),
                      }}
                    ></span>
                  </span>
                  <span className="home1-thq-tab-desc-elm1">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw('TabDesc_kCdFBU'),
                      }}
                    ></span>
                  </span>
                </button>
                <button data-target="dash-2" className="tab-trigger">
                  <span className="home1-thq-tab-label-elm2">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw('TabLabel_RXVm1I'),
                      }}
                    ></span>
                  </span>
                  <span className="home1-thq-tab-desc-elm2">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw('TabDesc_57CxcN'),
                      }}
                    ></span>
                  </span>
                </button>
                <button data-target="dash-3" className="tab-trigger">
                  <span className="home1-thq-tab-label-elm3">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw('TabLabel_ma4EX_'),
                      }}
                    ></span>
                  </span>
                  <span className="home1-thq-tab-desc-elm3">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw('TabDesc_zgRLTe'),
                      }}
                    ></span>
                  </span>
                </button>
            ...
            <div className="integrations-container">
              <div className="integrations-header">
                <h2 className="section-title">
                  <span
                    dangerouslySetInnerHTML={{
                      __html: translate.raw('SectionTitle_P_JptB'),
                    }}
                  ></span>
                </h2>
                <p className="section-subtitle">
                  <span
                    dangerouslySetInnerHTML={{
                      __html: translate.raw('SectionSubtitle_mtNo9R'),
                    }}
                  ></span>
                </p>
              </div>
              <div className="integrations-bento">
                <div className="main-cell int-cell">
                  <div className="int-content">
                    <h3 className="section-title">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('SectionTitle_f2KxMG'),
                        }}
                      ></span>
                    </h3>
                    <p className="section-content">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('SectionContent_BY9Jm8'),
                        }}
                      ></span>
                    </p>
                    <div className="int-tags">
                      <span className="int-tag">
                        <span
                          dangerouslySetInnerHTML={{
                            __html: translate.raw('IntTag_CedT3j'),
                          }}
                        ></span>
                      </span>
                      <span className="int-tag">
                        <span
                          dangerouslySetInnerHTML={{
                            __html: translate.raw('IntTag_Oy68P-'),
                          }}
                        ></span>
                      </span>
                      <span className="int-tag">
                        <span
                          dangerouslySetInnerHTML={{
                            __html: translate.raw('IntTag_MXealP'),
                          }}
                        ></span>
                      </span>
                    </div>
                  ...
                  <div className="logo-grid">
                    <div className="logo-item">
                      <span>
                        <span
                          dangerouslySetInnerHTML={{
                            __html: translate.raw('text_9F3UiM'),
                          }}
                        ></span>
                      </span>
                    </div>
                    <div className="logo-item">
                      <span>
                        <span
                          dangerouslySetInnerHTML={{
                            __html: translate.raw('text_52dkbe'),
                          }}
                        ></span>
                      </span>
                    </div>
                    <div className="logo-item">
                      <span>
                        <span
                          dangerouslySetInnerHTML={{
                            __html: translate.raw('text_gngiAE'),
                          }}
                        ></span>
                      </span>
                    </div>
                    <div className="logo-item">
                      <span>
                        <span
                          dangerouslySetInnerHTML={{
                            __html: translate.raw('text_QgWsRz'),
                          }}
                        ></span>
                      </span>
                    </div>
                ...
                <div className="note-cell int-cell">
                  <h4 className="section-title">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw('SectionTitle_QLEfCi'),
                      }}
                    ></span>
                  </h4>
                  <p className="section-content">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw('SectionContent_MqXVXw'),
                      }}
                    ></span>
                  </p>
                </div>
              ...
              <div className="stats-cell-wide">
                ...
                <div className="stats-content">
                  <h2 className="section-title">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw('SectionTitle_uQdpcu'),
                      }}
                    ></span>
                  </h2>
                  <p className="section-content">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw('SectionContent_w-rqGl'),
                      }}
                    ></span>
                  </p>
                  <div className="stats-main-number">
                    <span>
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('text_D0S4pM'),
                        }}
                      ></span>
                    </span>
                  </div>
                  <p className="section-subtitle">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw('SectionSubtitle_iV4VYv'),
                      }}
                    ></span>
                  </p>
                </div>
                ...
                <div className="stat-item">
                  <div className="stat-value">
                    <span>
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('text_2_i9D-'),
                        }}
                      ></span>
                    </span>
                  </div>
                  <div className="stat-label">
                    <span>
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('text_EQMWD0'),
                        }}
                      ></span>
                    </span>
                  </div>
                ...
                <div className="stat-item">
                  <div className="stat-value">
                    <span>
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('text_pWTZ7G'),
                        }}
                      ></span>
                    </span>
                  </div>
                  <div className="stat-label">
                    <span>
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('text_HnqpRI'),
                        }}
                      ></span>
                    </span>
                  </div>
          ...
          <section className="testimonials-section">
            <div className="testimonials-carousel-wrapper">
              <h2 className="section-title">
                <span
                  dangerouslySetInnerHTML={{
                    __html: translate.raw('SectionTitle_cHYaUI'),
                  }}
                ></span>
              </h2>
              <div id="testimonialSlider" className="testimonials-container">
                <div className="testimonial-card">
                  ...
                  <p className="section-content">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw('SectionContent_MOLmBC'),
                      }}
                    ></span>
                  </p>
                  <div className="testimonial-author">
                    <span className="author-name">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('AuthorName_4eQvdy'),
                        }}
                      ></span>
                    </span>
                    <span className="author-role">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('AuthorRole__dS_ec'),
                        }}
                      ></span>
                    </span>
                  </div>
                ...
                <div className="testimonial-card">
                  ...
                  <p className="section-content">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw('SectionContent_D5l4AC'),
                      }}
                    ></span>
                  </p>
                  <div className="testimonial-author">
                    <span className="author-name">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('AuthorName__WJsML'),
                        }}
                      ></span>
                    </span>
                    <span className="author-role">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('AuthorRole_KiUVf8'),
                        }}
                      ></span>
                    </span>
                  </div>
                ...
                <div className="testimonial-card">
                  ...
                  <p className="section-content">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw('SectionContent_yAyfP6'),
                      }}
                    ></span>
                  </p>
                  <div className="testimonial-author">
                    <span className="author-name">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('AuthorName_WpdteX'),
                        }}
                      ></span>
                    </span>
                    <span className="author-role">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('AuthorRole_SdwAot'),
                        }}
                      ></span>
                    </span>
                  </div>
            ...
            <div className="cta-bento-grid">
              <div className="cta-cell-main">
                <h2 className="section-title">
                  <span
                    dangerouslySetInnerHTML={{
                      __html: translate.raw('SectionTitle_lxiFM8'),
                    }}
                  ></span>
                </h2>
                <p className="section-subtitle">
                  <span
                    dangerouslySetInnerHTML={{
                      __html: translate.raw('SectionSubtitle_8llXCr'),
                    }}
                  ></span>
                </p>
                <form
                  action="/submit"
                  method="POST"
                  data-form-id="551e8fe1-10fd-414e-96ad-60b90b53ca08"
                  className="cta-form"
                >
                  <div className="form-group">
                    ...
                    >
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('Btn_bLUw0c'),
                        }}
                      ></span>
                    </button>
                  </div>
                  <p className="form-disclaimer">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw('FormDisclaimer_kkkwvR'),
                      }}
                    ></span>
                  </p>
                </form>
              ...
              <div className="cta-cell-links">
                <h3 className="section-title">
                  <span
                    dangerouslySetInnerHTML={{
                      __html: translate.raw('SectionTitle_BVfPWp'),
                    }}
                  ></span>
                </h3>
                  ...
                  <a href="#">
                    <div className="btn-link">
                      <span>
                        <span
                          dangerouslySetInnerHTML={{
                            __html: translate.raw('text_QC_L0k'),
                          }}
                        ></span>
                      </span>
                    </div>
                  ...
                  <a href="#">
                    <div className="btn-link">
                      <span>
                        <span
                          dangerouslySetInnerHTML={{
                            __html: translate.raw('text_JIDiy6'),
                          }}
                        ></span>
                      </span>
                    </div>
                  ...
                  <a href="#">
                    <div className="btn-link">
                      <span>
                        <span
                          dangerouslySetInnerHTML={{
                            __html: translate.raw('text_nxDasE'),
                          }}
                        ></span>
                      </span>
                    </div>
                  ...
                  <a href="#">
                    <div className="btn-link">
                      <span>
                        <span
                          dangerouslySetInnerHTML={{
                            __html: translate.raw('text_x6ng-J'),
                          }}
                        ></span>
                      </span>
                    </div>
              ...
              <div className="cta-cell-contact">
                <h3 className="section-title">
                  <span
                    dangerouslySetInnerHTML={{
                      __html: translate.raw('SectionTitle_bCIcAz'),
                    }}
                  ></span>
                </h3>
                <p className="section-content">
                  <span
                    dangerouslySetInnerHTML={{
                      __html: translate.raw('SectionContent_WPNBN2'),
                    }}
                  ></span>
                </p>
                <a href="mailto:contact@flowvista.com?subject=">
                  <div className="btn btn-sm btn-outline">
                    <span>
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('text_z31ERE'),
                        }}
                      ></span>
                    </span>
                  </div>
    ...
    ctaForm.addEventListener('submit', (e) => {
      ...
      <style jsx>
        {`
          ...
          .home1-thq-tab-desc-elm1 {
            opacity: 0.7;
            font-size: var(--font-size-sm);
          }
          .home1-thq-tab-label-elm2 {
            display: block;
            font-size: var(--font-size-xl);
            font-family: var(--font-family-heading);
            font-weight: bold;
          ...
          .home1-thq-tab-desc-elm2 {
            opacity: 0.7;
            font-size: var(--font-size-sm);
          }
          .home1-thq-tab-label-elm3 {
            display: block;
            font-size: var(--font-size-xl);
            font-family: var(--font-family-heading);
            font-weight: bold;
...
export async function getStaticProps(context) {
  try {
    const messages = (await import('/locales/' + context.locale + '.json'))
      .default
    const [javascript_PEC_data_data_Cuxc9aVo7I] = await Promise.all([
      javascriptData5ef2eac3
        ...
        .catch((error) => {
          console.error(
            'Error fetching javascript_PEC_data_data_Cuxc9aVo7I:',
            error
          )
          return []
        }),
    ...
    return {
      props: {
        messages,
        javascript_PEC_data_data_Cuxc9aVo7I:
          javascript_PEC_data_data_Cuxc9aVo7I,
      },
      revalidate: 1,
    }
