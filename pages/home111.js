              ...
              <div className="hero-content-area">
                <div className="hero-text-block">
                  ...
                  <DataProvider
                    ...
                    initialData={props.javascript_PEC_data_data_SDlwpGw83c}
...
export async function getStaticProps(context) {
  try {
    const messages = (await import('/locales/' + context.locale + '.json'))
      .default
    const [javascript_PEC_data_data_SDlwpGw83c] = await Promise.all([
      javascriptData5ef2eac3
        ...
        .catch((error) => {
          console.error(
            'Error fetching javascript_PEC_data_data_SDlwpGw83c:',
            error
          )
          return []
        }),
    ...
    return {
      props: {
        messages,
        javascript_PEC_data_data_SDlwpGw83c:
          javascript_PEC_data_data_SDlwpGw83c,
      },
      revalidate: 1,
    }
