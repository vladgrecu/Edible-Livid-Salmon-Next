  ...
  return (
    <>
      <div className="sign-in-container1">
        <Head>
          <title>{translate.raw('static_eMnx8O')}</title>
          <meta name="description" content={translate.raw('static_1n_QCV')} />
          <meta property="og:title" content={translate.raw('static_eMnx8O')} />
          <meta
            property="og:description"
            content={translate.raw('static_1n_QCV')}
          />
          <link
            rel="canonical"
          ...
          <link
            rel="alternate"
            hreflang="en"
            href="https://admin.teleporthq.ai/sign-in"
          />
          <link
            rel="alternate"
            hreflang="es"
            href="https://admin.teleporthq.ai/es/sign-in"
          />
          <link
            rel="alternate"
            hreflang="x-default"
        ...
        <section className="auth-section">
          <div className="auth-container">
            <div className="auth-layout">
              <aside className="auth-info">
                <div className="auth-info-content">
                  <h1 className="hero-title">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw('HeroTitle_r3bZZG'),
                      }}
                    ></span>
                  </h1>
                  <p className="section-content">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw('SectionContent_FlgWl_'),
                      }}
                    ></span>
                  </p>
              ...
              <main className="sign-in-thq-auth-forms-elm auth-forms">
                <div className="auth-card">
                  <div className="auth-tabs">
                    <button id="tab-login" className="active auth-tab">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('AuthTab_yGbO-a'),
                        }}
                      ></span>
                    </button>
                    <button id="tab-register" className="auth-tab">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('AuthTab_m9YhcU'),
                        }}
                      ></span>
                    </button>
                  </div>
                  <form
                    ...
                    action="/login"
                    method="POST"
                    data-form-id="e14722fc-3749-4f69-8c3f-d6f4595bb310"
                  ...
                  >
                    <div className="sign-in-form-group">
                      <label htmlFor="login-email" className="form-label">
                        <span
                          dangerouslySetInnerHTML={{
                            __html: translate.raw('FormLabel_l1ApRr'),
                          }}
                        ></span>
                      </label>
                      <input
                    ...
                    <div className="sign-in-form-group">
                      <label htmlFor="login-password" className="form-label">
                        <span
                          dangerouslySetInnerHTML={{
                            __html: translate.raw('FormLabel_30WFrx'),
                          }}
                        ></span>
                      </label>
                      <input
                    ...
                    <div className="form-actions">
                      ...
                      >
                        <span
                          dangerouslySetInnerHTML={{
                            __html: translate.raw('Btn_1rejep'),
                          }}
                        ></span>
                      </button>
                      <a href="#">
                        <div className="btn btn-link btn-sm">
                          <span>
                            <span
                              dangerouslySetInnerHTML={{
                                __html: translate.raw('text_8FoRlB'),
                              }}
                            ></span>
                          </span>
                        </div>
                  ...
                  <form
                    ...
                    action="/register"
                    method="POST"
                    data-form-id="23666d94-ef89-492c-aa8f-7d56e61b2331"
                    className="auth-form"
                  >
                    <div className="form-row">
                      <div className="sign-in-form-group">
                        <label htmlFor="reg-first" className="form-label">
                          <span
                            dangerouslySetInnerHTML={{
                              __html: translate.raw('FormLabel_MYczc7'),
                            }}
                          ></span>
                        </label>
                        <input
                      ...
                      <div className="sign-in-form-group">
                        <label htmlFor="reg-last" className="form-label">
                          <span
                            dangerouslySetInnerHTML={{
                              __html: translate.raw('FormLabel_4ABTm6'),
                            }}
                          ></span>
                        </label>
                        <input
                    ...
                    <div className="sign-in-form-group">
                      <label htmlFor="reg-email" className="form-label">
                        <span
                          dangerouslySetInnerHTML={{
                            __html: translate.raw('FormLabel_-av-jJ'),
                          }}
                        ></span>
                      </label>
                      <input
                    ...
                    <div className="sign-in-form-group">
                      <label htmlFor="reg-password" className="form-label">
                        <span
                          dangerouslySetInnerHTML={{
                            __html: translate.raw('FormLabel_9_x24H'),
                          }}
                        ></span>
                      </label>
                      <input
                    ...
                    <div className="form-actions">
                      ...
                      >
                        <span
                          dangerouslySetInnerHTML={{
                            __html: translate.raw('Btn_gWFwqZ'),
                          }}
                        ></span>
                      </button>
                    </div>
                    <p className="form-footer">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('FormFooter_XkD4DW'),
                        }}
                      ></span>
                    </p>
                  </form>
          ...
          <div className="features-container">
            <div className="sign-in-features-header">
              <h2 className="section-title">
                <span
                  dangerouslySetInnerHTML={{
                    __html: translate.raw('SectionTitle_w3An5G'),
                  }}
                ></span>
              </h2>
              <p className="section-subtitle">
                <span
                  dangerouslySetInnerHTML={{
                    __html: translate.raw('SectionSubtitle_dhg8HV'),
                  }}
                ></span>
              </p>
            </div>
              ...
              <div className="bento-wide bento-item">
                <div className="bento-content">
                  ...
                  <h3 className="section-subtitle">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw('SectionSubtitle_kD2Mkg'),
                      }}
                    ></span>
                  </h3>
                  <p className="section-content">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw('SectionContent_p5BXX_'),
                      }}
                    ></span>
                  </p>
                </div>
              ...
              <div className="bento-item">
                <div className="bento-content">
                  ...
                  <h3 className="section-subtitle">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw('SectionSubtitle_Vz-4Bm'),
                      }}
                    ></span>
                  </h3>
                  <p className="section-content">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw('SectionContent_ttmekc'),
                      }}
                    ></span>
                  </p>
                </div>
              ...
              <div className="bento-item">
                <div className="bento-content">
                  ...
                  <h3 className="section-subtitle">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw('SectionSubtitle_YjXMiN'),
                      }}
                    ></span>
                  </h3>
                  <p className="section-content">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw('SectionContent_ZVZj5S'),
                      }}
                    ></span>
                  </p>
                </div>
